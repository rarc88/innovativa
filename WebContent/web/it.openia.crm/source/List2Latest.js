...
enyo.kind({
            ...
            {kind:"Panels", name:"listPanels", classes:"onyx todos-panels", arrangerKind:"CarouselArranger", components: [
                ...
                {kind:"FittableRows", components: [
                    {kind:"onyx.Toolbar", ondragstart:"noDrag", style: "background-color: #64932D;", layoutKind:"FittableColumnsLayout", components: [
                        ...
                        {name:"LeadSearchInputDecorator", kind: "onyx.InputDecorator", components: [
							{name:"LeadSearchInput", kind: "onyx.Input",style: "width:50px;background-color: transparent;border: transparent;", placeholder: "Search", onchange:"LeadInputChanged"},
							{kind: "Image", src: "../web/it.openia.crm/images/search-input-search.png"}
						]},
                        {name:"newLeadButton",kind:"onyx.Button", content:"New", ontap:"newLeadPopupCall", attributes:{"data-role":"none"}},
                    ...
                    {name: "newActivityPopup", kind: "onyx.Popup", style:"font-size: 20px;padding: 12px;background: rgba(76, 76, 76, 0.82)",autoDismiss: false ,centered: true, floating: true, modal: true, 
                     ...
                     //popup nuovo lead
                     {name: "newLeadPopup", kind: "onyx.Popup", style:"width:250px;font-size: 20px;padding: 12px;background: rgba(76, 76, 76, 0.82)",autoDismiss: false ,centered: true, floating: true, modal: true, 
                    	components:[
                        	{tag:"center",style:"height: 100%;width: 100%;", components:[
                            	{kind:"FittableRows", style:"width: 100%;" , components: [
                                	{tag:"div", style:"height:10px;"},
                                        ...
                                        {kind:"FittableColumns", style:"width: 100%;" , components: [
                                        	{content:"First Name*",style:"width: 90px;font-size:14px;"},
                                        	{kind: "onyx.InputDecorator",style:"background-color:white;width: 150px;", components: [
                                        		{name:"LeadInsertFirstName",kind: "onyx.Input", placeholder: ""}
                                        	]}
                                        ]},
                                        {tag:"div", style:"height:10px;"},
                                        //cognome
                                        {kind:"FittableColumns", style:"width: 100%;" , components: [
                                        	{content:"Last Name*",style:"width: 90px;font-size:14px;"},
                                        	{kind: "onyx.InputDecorator",style:"background-color:white;width: 150px;", components: [
                                        		{name:"LeadInsertLastName",kind: "onyx.Input", placeholder: ""}
                                        	]}
                                        ]},
                                        {tag:"div", style:"height:10px;"},
                                        //nome commerciale
                                        {kind:"FittableColumns", style:"width: 100%;" , components: [
                                        	{content:"Commercial Name*",style:"width: 90px;font-size:14px;"},
                                        	{kind: "onyx.InputDecorator", style:"background-color:white;width: 150px;", components: [
                                        		{name:"LeadInsertCommercialName",kind: "onyx.Input", placeholder: ""}
                                        	]}
                                        ]},
                                        {tag:"div", style:"height:10px;"},
                                        //cellulare
                                        {kind:"FittableColumns", style:"width: 100%;" , components: [
                                        	{content:"Phone",style:"width: 90px;font-size:14px;"},
                                        	{kind: "onyx.InputDecorator", style:"background-color:white;width: 150px;", components: [
                                        		{name:"LeadInsertPhone", kind: "onyx.Input", placeholder: ""}
                                        	]}
                                        ]},
                                    	{tag:"div", style:"height:10px;"},
                                    	//email
                                        {kind:"FittableColumns", style:"width: 100%;" , components: [
                                        	{content:"Email",style:"width: 90px;font-size:14px;"},
                                        	{kind: "onyx.InputDecorator", style:"background-color:white;width: 150px;", components: [
                                        		{name:"LeadInsertEmail", kind: "onyx.Input", placeholder: ""}
                                        	]}
                                        ]},
                                    	{tag:"div", style:"height:10px;"},
                                    	{content:"(*) Mandatory Fields",style:"font-size:14px;"},
                                    	{tag:"div", style:"height:10px;"}
                                    ]},
                                {kind:"FittableColumns", style:"text-align: inherit; width:100%;", components: [
                        			{kind:"onyx.Button", content:"Save", ontap:"saveNewLead"},
                        			{tag:"div", style:"width: 4%;"},
                        			{kind:"onyx.Button", content:"Cancel", ontap:"CancelLead"},	 
                      			]}    
                        	]},
                      	{name: "messageLeadPopup", kind: "onyx.Popup", style:"font-size: 20px;padding: 12px;background: orange",centered: true, floating: true, modal: true}
                      ]},
                ...
                {kind:"FittableRows", components: [
                    ...
                    {kind:"onyx.Toolbar", ondragstart:"noDrag", style: "background-color: #64932D;", layoutKind:"FittableColumnsLayout", components: [
                        {kind:"onyx.Button", content:"Back", ontap:"backToLists", attributes:{"data-role":"none"}},
                        {fit:true}
                    ]}
                ]},
                {kind:"FittableRows", components: [
                    ...
                    {kind:"onyx.Toolbar", ondragstart:"noDrag", style: "background-color: #64932D;", layoutKind:"FittableColumnsLayout", components: [
                        {kind:"onyx.Button", content:"Back", ontap:"backToElementList", attributes:{"data-role":"none"}},
                        {fit:true}
                    ]}
                ]},
                {kind:"FittableRows", components: [
                    ...
                    {kind:"onyx.Toolbar", ondragstart:"noDrag", style: "background-color: #64932D;", layoutKind:"FittableColumnsLayout", components: [
                        {kind:"onyx.Button", content:"Back", ontap:"backToDetailList", attributes:{"data-role":"none"}},
                        {fit:true}
                    ]}
                ]}
    ...
    selectMenuItem: function(inSender, inEvent) {
        ...
        if(this.selectedItemType!='ACTIVITY' & this.selectedItemType != 'OPPORTUNITY' & this.selectedItemType != 'LEAD')
			...
			if(this.selectedItemType=='ACTIVITY'){	
				...
				this.$.newLeadButton.hide();
				this.$.LeadSearchInputDecorator.hide();
				...
				this.$.descrDailyRepeater.hide();
				this.$.newActivityButton.hide();
				this.$.newLeadButton.show();
				this.$.LeadSearchInputDecorator.show();				
                                this.$.nextSevenDays.hide();
                                this.$.prevSevenDays.hide();
	...
	newLeadPopupCall: function(inSender, inEvent){
		this.$.LeadInsertFirstName.setValue("");
        this.$.LeadInsertFirstName.setContent("");
		
		this.$.LeadInsertLastName.setValue("");
        this.$.LeadInsertLastName.setContent("");
		
		this.$.LeadInsertCommercialName.setValue("");
        this.$.LeadInsertCommercialName.setContent("");
		
		this.$.LeadInsertPhone.setValue("");
        this.$.LeadInsertPhone.setContent("");
		
		this.$.LeadInsertEmail.setValue("");
        this.$.LeadInsertEmail.setContent("");
		
		this.$.newLeadPopup.show();
	},
	CancelLead: function(){
		this.$.newLeadPopup.hide();	
	},
	
	saveNewLead: function(inSender, inEvent){
                var popup = this.$.messageLeadPopup;
                
		if( this.$.LeadInsertFirstName.getValue().length==0 || this.$.LeadInsertLastName.getValue().length==0 ||
		    this.$.LeadInsertCommercialName.getValue().length==0 /*	|| this.$.LeadInsertPhone.getValue().length==0 ||
		    this.$.LeadInsertEmail.getValue().length==0 */ ){
			popup.setContent("Please fill in the mandatory fields!");
			popup.show();
			...
			var obj=this;
                        $.ajax({
                            url: "../it.openia.crm.InsertLead",
                            data: {
                                firstname:this.$.LeadInsertFirstName.getValue(),
                                lastname:this.$.LeadInsertLastName.getValue(),
                                commercialname: this.$.LeadInsertCommercialName.getValue(),
                                phone: this.$.LeadInsertPhone.getValue(),
                                email:this.$.LeadInsertEmail.getValue()
                            } 
                        }).done(function(data) { 
                            if(data.match(/OK/)){
        ...
        refreshLeads:function(inSender, inEvent){
            this.$.contentSearch.getTypeDetails("",this.selectedItemType);
        },
        
        LeadInputChanged:function(inSender, inEvent) {
        
        	this.LeadSearchText = this.$.LeadSearchInput.getValue();
        	this.$.contentSearch.search(this.searchText,this.selectedPickerValue);
    		
    		this.$.contentSearch.getTypeDetails("",this.selectedItemType,'',this.LeadSearchText);
    	},
	...
	*/
	...
	setDescr: function(inSender, inEvent){
        ...
        if(this.dataDescrTypes != undefined)
        	item.$.typeDescr.setDetail(this.dataDescrTypes[i],this.dataDescrNames,this.selectedItemType,this.lStatuses);
...
enyo.kind({
   ...
   getMenuInfoTypes: function(){
    ...
    getTypeDetails: function( bpId, lookupEnum, deltaDays, LeadsSarchText){
    	var detailList;
        var detailNames;
...
enyo.kind({
	...
	components: [
		...
		{name: "name4", classes: "list-sample-contacts-description"},
		
		{name: "name3", classes: "list-sample-contacts-description"},
		{kind: "onyx.PickerDecorator", onSelect: "itemSelected", name:"actLeadStatusPicker", components:[
                	{style:"width: 165px;font-size: 15px;height: 20px;padding: 0px;"},
                	{kind: "onyx.Picker", style:"width: 165px;font-size:15px;", name:"actLeadStatusDDList"}
                    ],
	...
	setDetail: function(inContact,inContactNames, inType, statusesArray) {
		this.$.name1.setContent(inContact.value1);

		if(this.validatePhone(inContact.value2))
			this.$.name2.setAttribute("href", "tel:"+inContact.value2); 
		else	
			this.$.name2.setAttribute("href", null); 
			
		this.$.name2.setContent(inContactNames.value2+" : "+inContact.value2);
		
		if(inType!='LEAD'){
			this.$.actLeadStatusPicker.hide();
			this.$.name3.setContent(inContactNames.value3+" : "+inContact.value3);
			this.$.name3.applyStyle("font-weight", null);
		}
		else{
			this.$.actLeadStatusPicker.show();
			this.setLeadStatuses(statusesArray,inContact.value4num);
			this.$.leadId.setContent(inContact.id);
			this.$.name3.setContent(inContactNames.value3);
			this.$.name3.applyStyle("font-weight", "bold");
		}
		if(inContact.value5!=undefined && inContact.value5.length !=0 )
			this.$.name4.setContent("Email : "+inContact.value5);		
		else this.$.name4.setContent("");
	...
	validatePhone: function(txtPhone) {
    	...
    	var filter = /^[0-9-+]+$/;
    	if (txtPhone.length>0 && filter.test(txtPhone)) {
        	return true;
    	}
    	else {
    		return false;
   ...
   setLeadStatuses: function(statusesArray,index){
            this.$.actLeadStatusDDList.createComponent({value:"-1", content:""});
            var list = this.$.actLeadStatusDDList;
