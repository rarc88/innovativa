...
if (OB.resizing && (n && n.attributes && n.attributes.class && _.isString(n.attributes.class) && n.attributes.class.startsWith('enyo-popup onyx-popup') && !(n.attributes.class.startsWith('enyo-popup onyx-popup onyx-menu')))) {
e += "";
} else {
...
if (OB.resizing && (this && this.attributes && this.attributes.class && _.isString(this.attributes.class) && this.attributes.class.startsWith('enyo-popup onyx-popup') && !(this.attributes.class.startsWith('enyo-popup onyx-popup onyx-menu')))) {
return;
}
...
if (enyo.$[e]){console.error(enyo.format("[enyo] Duplicated DOM id '%s'", e), t, "will overwrite to", enyo.$[e]);}
enyo.$[e] = t;
},
...
(function() {
var e = Math.round(1e3 / 60), t = [ "", "moz", "ms", "o", "" ], n = "requestAnimationFrame", r = "cancel" + enyo.cap(n), i = function(t) {
