...
enyo.path.addPaths({layout: "/tmp/bootplate/enyo/tools/../../lib/layout/", onyx: "/tmp/bootplate/enyo/tools/../../lib/onyx/", onyx: "/tmp/bootplate/enyo/tools/../../lib/onyx/source/", notification: "/tmp/bootplate/enyo/tools/../../lib/notification/"});
...
findZIndex: function(a){
var e=this.defaultZ;
return OB._maxZindex = OB._maxZindex || 1, this._zIndex ? e = this._zIndex : this.hasNode() && (e = Number(enyo.dom.getComputedStyleValue(this.node, "z-index")) || e), e < OB._maxZindex && !a ? (OB._maxZindex += 2, e = OB._maxZindex) : OB._maxZindex = e, this._zIndex = e;
}
});
