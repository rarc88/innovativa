...
static Logger log4j = Logger.getLogger(ReportGeneralLedgerJournalData.class);
  ...
  public String viaticalDescription;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("namedocbasetype"))
      ...
      return documentno;
    else if (fieldName.equalsIgnoreCase("viatical_description") || fieldName.equals("viaticalDescription"))
      return viaticalDescription;
    else if (fieldName.equalsIgnoreCase("viaticaldate"))
      return viaticaldate;
  ...
  public static ReportGeneralLedgerJournalData[] select(ConnectionProvider connectionProvider, String viatical, String language)    throws ServletException {
    return select(connectionProvider, viatical, language, 0, 0);
  }

  public static ReportGeneralLedgerJournalData[] select(ConnectionProvider connectionProvider, String viatical, String language, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "SELECT NAMEDOCBASETYPE,ORGANIZATION,PARTNER_NAME,DOCUMENTNO,VIATICAL_DESCRIPTION," +
      "VIATICALDATE,GRANDTOTAL," +
      ...
      " FROM (" +
      "	SELECT coalesce(ARLT.NAME,ARL.NAME) AS NAMEDOCBASETYPE,AD.NAME AS ORGANIZATION,'' AS DOCNAME,CBP.NAME AS PARTNER_NAME," +
      "	SV.DOCUMENTNO AS DOCUMENTNO," +
      "	SV.DESCRIPTION AS VIATICAL_DESCRIPTION,to_char(SV.VIATICALDATE) as VIATICALDATE," +
      "	SV.TOTALAMT AS GRANDTOTAL," +
      ...
      "	) AA" +
      "	LEFT JOIN SSVE_Viatical_Settlement SV ON SV.SSVE_Viatical_Settlement_ID = AA.RECORD_ID" +
      "	LEFT JOIN C_BPARTNER CBP ON CBP.C_BPARTNER_ID = SV.C_BPARTNER_ID" +
      "	LEFT JOIN AD_ORG AD ON AD.AD_ORG_ID = SV.AD_ORG_ID" +
      "	LEFT JOIN C_DOCTYPE CDT ON CDT.C_DOCTYPE_ID = SV.C_DOCTYPE_ID" +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReportGeneralLedgerJournalData.documentno = UtilSql.getValue(result, "documentno");
        objectReportGeneralLedgerJournalData.viaticalDescription = UtilSql.getValue(result, "viatical_description");
        objectReportGeneralLedgerJournalData.viaticaldate = UtilSql.getValue(result, "viaticaldate");
  ...
  public static ReportGeneralLedgerJournalData[] set()    throws ServletException {
    ...
    objectReportGeneralLedgerJournalData[0].documentno = "";
    objectReportGeneralLedgerJournalData[0].viaticalDescription = "";
    objectReportGeneralLedgerJournalData[0].viaticaldate = "";
