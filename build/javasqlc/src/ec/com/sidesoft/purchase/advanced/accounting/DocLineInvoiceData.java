...
static Logger log4j = Logger.getLogger(DocLineInvoiceData.class);
  ...
  public String accountNcprovedor;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("c_invoiceline_id") || fieldName.equals("cInvoicelineId"))
      ...
      return accountId;
    else if (fieldName.equalsIgnoreCase("account_ncprovedor") || fieldName.equals("accountNcprovedor"))
      return accountNcprovedor;
    else if (fieldName.equalsIgnoreCase("notconfig"))
      return notconfig;
    else if (fieldName.equalsIgnoreCase("il_taxamt") || fieldName.equals("ilTaxamt"))
      return ilTaxamt;
   else {
  ...
  public static DocLineInvoiceData[] select(ConnectionProvider connectionProvider, String C_Invoice_ID, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectDocLineInvoiceData.accountId = UtilSql.getValue(result, "account_id");
        objectDocLineInvoiceData.accountNcprovedor = UtilSql.getValue(result, "account_ncprovedor");
        objectDocLineInvoiceData.notconfig = UtilSql.getValue(result, "notconfig");
  ...
  public static DocLineInvoiceData[] selectAccountBParnet(ConnectionProvider connectionProvider, String acctschemaId, String bpartnerId, String invoiceline)    throws ServletException {
    return selectAccountBParnet(connectionProvider, acctschemaId, bpartnerId, invoiceline, 0, 0);
  }

  public static DocLineInvoiceData[] selectAccountBParnet(ConnectionProvider connectionProvider, String acctschemaId, String bpartnerId, String invoiceline, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, acctschemaId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, bpartnerId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, invoiceline);
  ...
  public static DocLineInvoiceData[] selectAccountNCProveedor(ConnectionProvider connectionProvider, String acctschemaId, String bpartnerId, String invoiceline)    throws ServletException {
    return selectAccountNCProveedor(connectionProvider, acctschemaId, bpartnerId, invoiceline, 0, 0);
  }

  public static DocLineInvoiceData[] selectAccountNCProveedor(ConnectionProvider connectionProvider, String acctschemaId, String bpartnerId, String invoiceline, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static DocLineInvoiceData[] existInvoiceLineNotConfig(ConnectionProvider connectionProvider, String C_INVOICE_ID, String c_acctschema_id, String c_bpartner_id)    throws ServletException {
    return existInvoiceLineNotConfig(connectionProvider, C_INVOICE_ID, c_acctschema_id, c_bpartner_id, 0, 0);
  }

  public static DocLineInvoiceData[] existInvoiceLineNotConfig(ConnectionProvider connectionProvider, String C_INVOICE_ID, String c_acctschema_id, String c_bpartner_id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
