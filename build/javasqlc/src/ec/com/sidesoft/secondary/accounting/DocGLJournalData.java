...
static Logger log4j = Logger.getLogger(DocGLJournalData.class);
  ...
  public static DocGLJournalData[] selectFinInvCount(ConnectionProvider connectionProvider, String ssacct_journal, String acctschema_id)    throws ServletException {
    return selectFinInvCount(connectionProvider, ssacct_journal, acctschema_id, 0, 0);
  }

  public static DocGLJournalData[] selectFinInvCount(ConnectionProvider connectionProvider, String ssacct_journal, String acctschema_id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      QueryTimeOutUtil.getInstance().setQueryTimeOut(st, SessionInfo.getQueryProfile());
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, ssacct_journal);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, ssacct_journal);
