...
package ec.com.sidesoft.secondary.accounting.ad_reports;
...
static Logger log4j = Logger.getLogger(ReportGeneralLedgerData.class);
  ...
  public String ssacctFactacctsecondaryId;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("rn1"))
      ...
      return factaccttype;
    else if (fieldName.equalsIgnoreCase("ssacct_factacctsecondary_id") || fieldName.equals("ssacctFactacctsecondaryId"))
      return ssacctFactacctsecondaryId;
  ...
  public static ReportGeneralLedgerData[] select(ConnectionProvider connectionProvider, String rownum, String groupbytext, String groupby, String adLanguage, String parDateFrom, String parDateTo, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String hideMatched, String parDateFrom2, String parDateTo2, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo, String accountId, String factAcctId, String cBPartner, String pgLimit, String oraLimit1, String oraLimit2)    throws ServletException {
    return select(connectionProvider, rownum, groupbytext, groupby, adLanguage, parDateFrom, parDateTo, allaccounts, accountFrom, accountTo, adUserOrg, adUserClient, hideMatched, parDateFrom2, parDateTo2, org, cBpartnerId, mProductId, cProjectId, paramAmtFrom, paramAmtTo, accountId, factAcctId, cBPartner, pgLimit, oraLimit1, oraLimit2, 0, 0);
  }

  public static ReportGeneralLedgerData[] select(ConnectionProvider connectionProvider, String rownum, String groupbytext, String groupby, String adLanguage, String parDateFrom, String parDateTo, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String hideMatched, String parDateFrom2, String parDateTo2, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo, String accountId, String factAcctId, String cBPartner, String pgLimit, String oraLimit1, String oraLimit2, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT * FROM (" +
      "        SELECT *" +
    ...
    strSql = strSql + 
      ...
      "              factaccttype, '' as ssacct_factacctsecondary_id, 0 AS AMTACCTDRPREVSUM, 0 AS AMTACCTCRPREVSUM" +
      "          FROM" +
      "            (SELECT ssacct_factacctsecondary.ACCTVALUE AS VALUE, ssacct_factacctsecondary.ACCTDESCRIPTION AS NAME," +
      "                DATEACCT, AMTACCTDR, AMTACCTCR," +
      "                FACT_ACCT_GROUP_ID, ssacct_factacctsecondary.ACCOUNT_ID AS ID, ssacct_factacctsecondary.DESCRIPTION," +
      "                CASE ?" +
      ...
      "		CASE WHEN ssacct_factacctsecondary.FACTACCTTYPE = 'O' THEN 1 ELSE (CASE WHEN ssacct_factacctsecondary.FACTACCTTYPE = 'N' THEN 2 ELSE (CASE WHEN ssacct_factacctsecondary.FACTACCTTYPE = 'R' THEN 3 ELSE (CASE WHEN ssacct_factacctsecondary.FACTACCTTYPE = 'C' THEN 4 END) END) END) END AS FACTACCTTYPE" +
      "            FROM ssacct_factacctsecondary" +
      "              LEFT JOIN C_BPARTNER ON ssacct_factacctsecondary.C_BPARTNER_ID = C_BPARTNER.C_BPARTNER_ID" +
      "              LEFT JOIN M_PRODUCT ON ssacct_factacctsecondary.M_PRODUCT_ID = M_PRODUCT.M_PRODUCT_ID" +
      "              LEFT JOIN C_PROJECT ON ssacct_factacctsecondary.C_PROJECT_ID = C_PROJECT.C_PROJECT_ID" +
      "              LEFT JOIN(" +
      "                  select account_id, record_id2, sum(amtacctdr-amtacctcr) as sum" +
      "                  from ssacct_factacctsecondary f1" +
      "                  where 5=5";
    ...
    strSql = strSql + 
      ...
      "                ) f2 ON ssacct_factacctsecondary.account_id = f2.account_id and ssacct_factacctsecondary.record_id2 = f2.record_id2" +
      "            WHERE (?='Y' OR ssacct_factacctsecondary.ACCOUNT_ID IN (" +
      ...
      "                    ))" +
      "              AND ssacct_factacctsecondary.AD_ORG_ID IN (";
    strSql = strSql + ((adUserOrg==null || adUserOrg.equals(""))?"":adUserOrg);
    strSql = strSql + 
      ")" +
      "              AND ssacct_factacctsecondary.AD_CLIENT_ID IN (";
    strSql = strSql + ((adUserClient==null || adUserClient.equals(""))?"":adUserClient);
    strSql = strSql + 
      ")" +
      "              AND (? = 'N' OR (ssacct_factacctsecondary.RECORD_ID2 IS NULL) OR (SUM != 0))" +
      "              AND 1=1";
    strSql = strSql + ((parDateFrom2==null || parDateFrom2.equals(""))?"":" AND ssacct_factacctsecondary.DATEACCT >= TO_DATE(?)  ");
    strSql = strSql + ((parDateTo2==null || parDateTo2.equals(""))?"":" AND ssacct_factacctsecondary.DATEACCT < TO_DATE(?)  ");
    strSql = strSql + 
      "              AND  ssacct_factacctsecondary.AD_ORG_ID IN (";
    ...
    strSql = strSql + 
      ")" +
      "              AND 2=2";
    strSql = strSql + ((cBpartnerId==null || cBpartnerId.equals(""))?"":"  AND ssacct_factacctsecondary.C_BPARTNER_ID IN" + cBpartnerId);
    strSql = strSql + ((mProductId==null || mProductId.equals(""))?"":"  AND ssacct_factacctsecondary.M_PRODUCT_ID IN" + mProductId);
    strSql = strSql + ((cProjectId==null || cProjectId.equals(""))?"":"  AND ssacct_factacctsecondary.C_PROJECT_ID IN" + cProjectId);
    strSql = strSql + 
      "              AND 3=3";
    strSql = strSql + ((paramAmtFrom==null || paramAmtFrom.equals(""))?"":"  AND (ssacct_factacctsecondary.AMTACCTDR + ssacct_factacctsecondary.AMTACCTCR)>=TO_NUMBER(?)  ");
    strSql = strSql + ((paramAmtTo==null || paramAmtTo.equals(""))?"":"  AND (ssacct_factacctsecondary.AMTACCTDR + ssacct_factacctsecondary.AMTACCTCR)<=TO_NUMBER(?)  ");
    strSql = strSql + 
      ") D" +
      "            WHERE 6=6";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReportGeneralLedgerData.ssacctFactacctsecondaryId = UtilSql.getValue(result, "ssacct_factacctsecondary_id");
  ...
  public static ReportGeneralLedgerData select2(ConnectionProvider connectionProvider, String rownum, String groupbytext, String groupby, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String dateBalanced, String parDateFrom2, String parDateTo2, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo, String accountId, String cBPartner, String pgLimit, String oraLimit1, String oraLimit2, String factAcctId)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "              MAX(ssacct_factacctsecondary_ID) AS ssacct_factacctsecondary_ID," +
      "              FACT_ACCT_GROUP_ID, ID, groupbyid, groupbyname," +
      "              DESCRIPTION, ISDEBIT," +
      "              0 AS TOTALACCTDR, 0 AS TOTALACCTCR, 0 AS TOTALACCTSUB," +
      "              0 AS PREVIOUSDEBIT, 0 AS PREVIOUSCREDIT, 0 AS PREVIOUSTOTAL," +
      ...
      "          FROM" +
      "            (SELECT ssacct_factacctsecondary.ACCTVALUE AS VALUE, ssacct_factacctsecondary.ACCTDESCRIPTION AS NAME," +
      "                DATEACCT, AMTACCTDR, AMTACCTCR, ssacct_factacctsecondary_ID," +
      "                FACT_ACCT_GROUP_ID, ssacct_factacctsecondary.ACCOUNT_ID AS ID, ssacct_factacctsecondary.DESCRIPTION," +
      "                CASE ?" +
      "                  WHEN 'BPartner' THEN c_bpartner.c_bpartner_id" +
      "                  WHEN 'Product' THEN m_product.m_product_id" +
    ...
    strSql = strSql + 
      ")" +
      "              AND 1=1";
    strSql = strSql + ((dateBalanced==null || dateBalanced.equals(""))?"":" AND (ssacct_factacctsecondary.DATEBALANCED IS NULL OR ssacct_factacctsecondary.DATEBALANCED > TO_DATE(?))  ");
    strSql = strSql + ((parDateFrom2==null || parDateFrom2.equals(""))?"":" AND ssacct_factacctsecondary.DATEACCT >= TO_DATE(?)  ");
    strSql = strSql + ((parDateTo2==null || parDateTo2.equals(""))?"":" AND ssacct_factacctsecondary.DATEACCT < TO_DATE(?)  ");
    strSql = strSql + 
      "              AND  ssacct_factacctsecondary.AD_ORG_ID IN (";
    ...
    strSql = strSql + 
      ...
      "            HAVING SUM(AMTACCTDR) - SUM(AMTACCTCR) <> 0" +
      "            ORDER  BY groupbyname, groupbyid, VALUE, NAME, ID," +
      "            DATEACCT, FACTACCTTYPE, FACT_ACCT_GROUP_ID,  ssacct_factacctsecondary_ID, DESCRIPTION, ISDEBIT";
    strSql = strSql + ((pgLimit==null || pgLimit.equals(""))?"":"  LIMIT " + pgLimit);
    strSql = strSql + 
      "          ) C";
    strSql = strSql + ((oraLimit1==null || oraLimit1.equals(""))?"":"  WHERE ROWNUM <= " + oraLimit1);
    strSql = strSql + 
      "        ) B WHERE 1=1";
    strSql = strSql + ((oraLimit2==null || oraLimit2.equals(""))?"":"  AND RN1 BETWEEN " + oraLimit2);
    strSql = strSql + ((factAcctId==null || factAcctId.equals(""))?"":"  and to_char(DATEACCT,'J')||FACTACCTTYPE||FACT_ACCT_GROUP_ID||ssacct_factacctsecondary_ID < ?  ");
  ...
  public static ReportGeneralLedgerData[] select2sum(ConnectionProvider connectionProvider, String rownum, String groupbytext, String groupby, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String parDateFrom2, String parDateTo2, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo, String accountId, String cBPartner, String pgLimit, String oraLimit1, String oraLimit2, String factAcctId, String accountId2)    throws ServletException {
    return select2sum(connectionProvider, rownum, groupbytext, groupby, allaccounts, accountFrom, accountTo, adUserOrg, adUserClient, parDateFrom2, parDateTo2, org, cBpartnerId, mProductId, cProjectId, paramAmtFrom, paramAmtTo, accountId, cBPartner, pgLimit, oraLimit1, oraLimit2, factAcctId, accountId2, 0, 0);
  }

  public static ReportGeneralLedgerData[] select2sum(ConnectionProvider connectionProvider, String rownum, String groupbytext, String groupby, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String parDateFrom2, String parDateTo2, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo, String accountId, String cBPartner, String pgLimit, String oraLimit1, String oraLimit2, String factAcctId, String accountId2, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static ReportGeneralLedgerData[] select2Total(ConnectionProvider connectionProvider, String rownum, String groupbytext, String groupby, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String parDateFrom2, String parDateTo2, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo, String accountId, String cBPartner, String pgLimit, String oraLimit1, String oraLimit2, String factAcctId)    throws ServletException {
    return select2Total(connectionProvider, rownum, groupbytext, groupby, allaccounts, accountFrom, accountTo, adUserOrg, adUserClient, parDateFrom2, parDateTo2, org, cBpartnerId, mProductId, cProjectId, paramAmtFrom, paramAmtTo, accountId, cBPartner, pgLimit, oraLimit1, oraLimit2, factAcctId, 0, 0);
  }

  public static ReportGeneralLedgerData[] select2Total(ConnectionProvider connectionProvider, String rownum, String groupbytext, String groupby, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String parDateFrom2, String parDateTo2, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo, String accountId, String cBPartner, String pgLimit, String oraLimit1, String oraLimit2, String factAcctId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static ReportGeneralLedgerData[] selectXLS(ConnectionProvider connectionProvider, String adLanguage, String parDateFrom, String parDateTo, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String hideMatched, String parDateFrom2, String parDateTo2, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo)    throws ServletException {
    return selectXLS(connectionProvider, adLanguage, parDateFrom, parDateTo, allaccounts, accountFrom, accountTo, adUserOrg, adUserClient, hideMatched, parDateFrom2, parDateTo2, org, cBpartnerId, mProductId, cProjectId, paramAmtFrom, paramAmtTo, 0, 0);
  }

  public static ReportGeneralLedgerData[] selectXLS(ConnectionProvider connectionProvider, String adLanguage, String parDateFrom, String parDateTo, String allaccounts, String accountFrom, String accountTo, String adUserOrg, String adUserClient, String hideMatched, String parDateFrom2, String parDateTo2, String org, String cBpartnerId, String mProductId, String cProjectId, String paramAmtFrom, String paramAmtTo, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT VALUE, NAME, DATEACCT," +
  ...
  public static ReportGeneralLedgerData[] selectTotal(ConnectionProvider connectionProvider, String dateFrom, String dateTo, String bpartner, String bpartnerNULL, String product, String productNULL, String project, String projectNULL, String account, String initialYearBalance, String dateTo2, String orgs, String hideMatched)    throws ServletException {
    return selectTotal(connectionProvider, dateFrom, dateTo, bpartner, bpartnerNULL, product, productNULL, project, projectNULL, account, initialYearBalance, dateTo2, orgs, hideMatched, 0, 0);
  }

  public static ReportGeneralLedgerData[] selectTotal(ConnectionProvider connectionProvider, String dateFrom, String dateTo, String bpartner, String bpartnerNULL, String product, String productNULL, String project, String projectNULL, String account, String initialYearBalance, String dateTo2, String orgs, String hideMatched, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    strSql = strSql + 
      ...
      "      ) f2 ON ssacct_factacctsecondary.account_id = f2.account_id and ssacct_factacctsecondary.record_id2 = f2.record_id2" +
      "      WHERE 1=1";
    strSql = strSql + ((bpartner==null || bpartner.equals(""))?"":"  AND ssacct_factacctsecondary.C_BPARTNER_ID IN" + bpartner);
    strSql = strSql + ((bpartnerNULL==null || bpartnerNULL.equals(""))?"":"  AND ssacct_factacctsecondary.C_BPARTNER_ID IS NULL" + bpartnerNULL);
    strSql = strSql + ((product==null || product.equals(""))?"":"  AND ssacct_factacctsecondary.M_PRODUCT_ID IN" + product);
    strSql = strSql + ((productNULL==null || productNULL.equals(""))?"":"  AND ssacct_factacctsecondary.M_PRODUCT_ID IS NULL" + productNULL);
    strSql = strSql + ((project==null || project.equals(""))?"":"  AND ssacct_factacctsecondary.C_PROJECT_ID IN" + project);
    strSql = strSql + ((projectNULL==null || projectNULL.equals(""))?"":"  AND ssacct_factacctsecondary.C_PROJECT_ID IS NULL" + projectNULL);
    strSql = strSql + 
      "      AND ssacct_factacctsecondary.ACCOUNT_ID = ?" +
    ...
    strSql = strSql + 
      ")" +
      "      AND (? = 'N' OR ((ssacct_factacctsecondary.RECORD_ID2 IS NULL) OR (DATEACCT < TO_DATE(?)) OR (SUM != 0)))";
  ...
  public static ReportGeneralLedgerData[] selectTotal2(ConnectionProvider connectionProvider, String bpartner, String bpartnerNULL, String product, String productNULL, String project, String projectNULL, String account, String dateFrom, String dateTo2, String orgs)    throws ServletException {
    return selectTotal2(connectionProvider, bpartner, bpartnerNULL, product, productNULL, project, projectNULL, account, dateFrom, dateTo2, orgs, 0, 0);
  }

  public static ReportGeneralLedgerData[] selectTotal2(ConnectionProvider connectionProvider, String bpartner, String bpartnerNULL, String product, String productNULL, String project, String projectNULL, String account, String dateFrom, String dateTo2, String orgs, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "      SELECT COALESCE(SUM(AMTACCTDR),0) AS TOTALACCTDR, COALESCE(SUM(AMTACCTCR),0) AS TOTALACCTCR," +
      "      COALESCE(SUM(AMTACCTDR-AMTACCTCR),0) AS TOTAL" +
