...
static Logger log4j = Logger.getLogger(ReportTrialBalanceData.class);
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("parent_id") || fieldName.equals("parentId"))
      ...
      return ccname;
    else if (fieldName.equalsIgnoreCase("element_id") || fieldName.equals("elementId"))
      return elementId;
  ...
  public static ReportTrialBalanceData[] select(ConnectionProvider connectionProvider, String dateFrom, String dateTo, String org, String treeAcct, String acctSchema, String factaccttype, String orgFamily, String adUserClient, String adUserOrg, String parDateFrom, String parDateTo, String accountFrom, String accountTo, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "      '' as bpid, '' as bpname, '' as pdid, '' as pdname, '' as pjid, '' as pjname, '' as ccid, '' as ccname, '' as element_id" +
      "      FROM" +
      ...
      "      FROM ssacct_factacctsecondary F, C_ELEMENTVALUE EV" +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectReportTrialBalanceData.elementId = UtilSql.getValue(result, "element_id");
  ...
  public static ReportTrialBalanceData[] set()    throws ServletException {
    ...
    objectReportTrialBalanceData[0].elementId = "";
    return objectReportTrialBalanceData;
  }

  public static ReportTrialBalanceData[] selectLines(ConnectionProvider connectionProvider, String grouByIdSqlIdentifier, String adLanguage, String parDateFrom, String openingEntryToInitialBalance, String openingEntryToYearAmounts, String grouByIdSql, String orgFamily, String adUserClient, String adUserOrg, String parDateTo, String accountId, String cBpartnerId, String mProductId, String cProjectId, String accountLevel, String grouByIdSql2, String accountFrom, String accountTo)    throws ServletException {
    return selectLines(connectionProvider, grouByIdSqlIdentifier, adLanguage, parDateFrom, openingEntryToInitialBalance, openingEntryToYearAmounts, grouByIdSql, orgFamily, adUserClient, adUserOrg, parDateTo, accountId, cBpartnerId, mProductId, cProjectId, accountLevel, grouByIdSql2, accountFrom, accountTo, 0, 0);
  }

  public static ReportTrialBalanceData[] selectLines(ConnectionProvider connectionProvider, String grouByIdSqlIdentifier, String adLanguage, String parDateFrom, String openingEntryToInitialBalance, String openingEntryToYearAmounts, String grouByIdSql, String orgFamily, String adUserClient, String adUserOrg, String parDateTo, String accountId, String cBpartnerId, String mProductId, String cProjectId, String accountLevel, String grouByIdSql2, String accountFrom, String accountTo, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    strSql = strSql + 
      " AS groupbyid" +
      "             FROM ssacct_factacctsecondary F" +
  ...
  public static ReportTrialBalanceData[] selectXLS(ConnectionProvider connectionProvider, String adLanguage, String accountLevel, String orgFamily, String adUserClient, String adUserOrg, String accountFrom, String accountTo, String parDateFrom, String cBpartnerId, String mProductId, String cProjectId, String factaccttype, String parDateTo)    throws ServletException {
    return selectXLS(connectionProvider, adLanguage, accountLevel, orgFamily, adUserClient, adUserOrg, accountFrom, accountTo, parDateFrom, cBpartnerId, mProductId, cProjectId, factaccttype, parDateTo, 0, 0);
  }

  public static ReportTrialBalanceData[] selectXLS(ConnectionProvider connectionProvider, String adLanguage, String accountLevel, String orgFamily, String adUserClient, String adUserOrg, String accountFrom, String accountTo, String parDateFrom, String cBpartnerId, String mProductId, String cProjectId, String factaccttype, String parDateTo, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "               FROM C_ELEMENTVALUE EV, ssacct_factacctsecondary F" +
  ...
  public static String treeAccount(ConnectionProvider connectionProvider, String client, String elementid)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT AD_TREE_ID" +
      "        FROM AD_TREE TR" +
      "        WHERE AD_CLIENT_ID = ?" +
      "              AND ISACTIVE = 'Y'" +
      "			  AND TR.AD_TREE_ID = ( SELECT MAX(EL.AD_TREE_ID) FROM C_ELEMENT El WHERE El.C_ELEMENT_ID = ? )";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, elementid);
  ...
  public static String selectLastAccount(ConnectionProvider connectionProvider, String adOrgClient, String adUserClient, String elementId)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    strSql = strSql + 
      ...
      "                AND C_ELEMENTVALUE.ISACTIVE='Y' AND  C_ELEMENT_ID = ? ) " +
      "			    AND C_ELEMENT_ID = ?	";
  ...
  public static ReportTrialBalanceData[] selectElemetdefault(ConnectionProvider connectionProvider, String and_client_id)    throws ServletException {
    return selectElemetdefault(connectionProvider, and_client_id, 0, 0);
  }

  public static ReportTrialBalanceData[] selectElemetdefault(ConnectionProvider connectionProvider, String and_client_id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select max(C_Element_id) as element_id from C_Element where elementtype = 'U'  " +
      "		and ad_client_id =  ?";
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      QueryTimeOutUtil.getInstance().setQueryTimeOut(st, SessionInfo.getQueryProfile());
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, and_client_id);
  ...
  public static ReportTrialBalanceData[] selectElemetCollection(ConnectionProvider connectionProvider, String and_client_id)    throws ServletException {
    return selectElemetCollection(connectionProvider, and_client_id, 0, 0);
  }

  public static ReportTrialBalanceData[] selectElemetCollection(ConnectionProvider connectionProvider, String and_client_id, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        select C_Element_id as id, name  from C_Element where elementtype = 'U'  " +
      "		and ad_client_id =  ?";
