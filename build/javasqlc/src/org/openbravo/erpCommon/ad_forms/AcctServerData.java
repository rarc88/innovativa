...
static Logger log4j = Logger.getLogger(AcctServerData.class);
  ...
  public static AcctServerData[] select(ConnectionProvider connectionProvider, String tableName, String dateColumn, String client, String StrOrg, String StrDocType, String dateFrom, String dateTo, String limit)    throws ServletException {
    return select(connectionProvider, tableName, dateColumn, client, StrOrg, StrDocType, dateFrom, dateTo, limit, 0, 0);
  }

  public static AcctServerData[] select(ConnectionProvider connectionProvider, String tableName, String dateColumn, String client, String StrOrg, String StrDocType, String dateFrom, String dateTo, String limit, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "	      Select * from(" +
      "        SELECT  a.";
    ...
    strSql = strSql + 
      ")" +
      "		AND PROCESSED='Y'";
    strSql = strSql + ((StrDocType==null || StrDocType.equals(""))?"":StrDocType);
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectAcctServerData.doctype = UtilSql.getValue(result, "doctype");
  ...
  public static AcctServerData selectDocumentsDates(ConnectionProvider connectionProvider, String columnName, String tableName, String adClientId, String StrOrg, String StrDocType, String docbasetype, String dateFrom, String dateTo)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
  ...
  public static AcctServerData[] selectDocTypes(ConnectionProvider connectionProvider, String table, String client, String StrDocTypeId)    throws ServletException {
    return selectDocTypes(connectionProvider, table, client, StrDocTypeId, 0, 0);
  }

  public static AcctServerData[] selectDocTypes(ConnectionProvider connectionProvider, String table, String client, String StrDocTypeId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      ...
      "      and ad_client_id = ?" +
      "	  and 1=1";
    strSql = strSql + ((StrDocTypeId==null || StrDocTypeId.equals(""))?"":StrDocTypeId);
  ...
  public static AcctServerData[] selectDocumetType(ConnectionProvider connectionProvider, String tableId)    throws ServletException {
    return selectDocumetType(connectionProvider, tableId, 0, 0);
  }

  public static AcctServerData[] selectDocumetType(ConnectionProvider connectionProvider, String tableId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "       SELECT   C_DOCTYPE.C_DOCTYPE_ID AS ID, C_DOCTYPE.Name  FROM C_DOCTYPE WHERE C_DOCTYPE.AD_TABLE_ID = ?";
