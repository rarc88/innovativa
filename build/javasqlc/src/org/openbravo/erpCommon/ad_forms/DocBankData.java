...
static Logger log4j = Logger.getLogger(DocBankData.class);
  ...
  public String emSswhLinecheck;
  public String emSswhPartnerId;
  public String emSswhPrint;
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("c_bankstatementline_id") || fieldName.equals("cBankstatementlineId"))
      ...
      return cGlitemId;
    else if (fieldName.equalsIgnoreCase("em_sswh_linecheck") || fieldName.equals("emSswhLinecheck"))
      return emSswhLinecheck;
    else if (fieldName.equalsIgnoreCase("em_sswh_partner_id") || fieldName.equals("emSswhPartnerId"))
      return emSswhPartnerId;
    else if (fieldName.equalsIgnoreCase("em_sswh_print") || fieldName.equals("emSswhPrint"))
      return emSswhPrint;
  ...
  public static DocBankData[] select(ConnectionProvider connectionProvider, String C_BankAccount_ID, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectDocBankData.emSswhLinecheck = UtilSql.getValue(result, "em_sswh_linecheck");
        objectDocBankData.emSswhPartnerId = UtilSql.getValue(result, "em_sswh_partner_id");
        objectDocBankData.emSswhPrint = UtilSql.getValue(result, "em_sswh_print");
