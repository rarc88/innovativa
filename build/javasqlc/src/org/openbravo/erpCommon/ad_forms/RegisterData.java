...
class RegisterData implements FieldProvider {
static Logger log4j = Logger.getLogger(RegisterData.class);
  ...
  public static int updateIsRegistrationActive(ConnectionProvider connectionProvider, String isregistrationactive)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      QueryTimeOutUtil.getInstance().setQueryTimeOut(st, SessionInfo.getQueryProfile());
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, isregistrationactive);
