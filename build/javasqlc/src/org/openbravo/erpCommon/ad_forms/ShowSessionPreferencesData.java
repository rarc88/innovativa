...
static Logger log4j = Logger.getLogger(ShowSessionPreferencesData.class);
  ...
  public static ShowSessionPreferencesData[] selectTrl(ConnectionProvider connectionProvider, String windows, String adLanguage)    throws ServletException {
    return selectTrl(connectionProvider, windows, adLanguage, 0, 0);
  }

  public static ShowSessionPreferencesData[] selectTrl(ConnectionProvider connectionProvider, String windows, String adLanguage, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
