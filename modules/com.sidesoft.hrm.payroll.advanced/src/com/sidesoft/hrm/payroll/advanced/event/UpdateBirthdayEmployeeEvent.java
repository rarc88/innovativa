...
public class UpdateBirthdayEmployeeEvent extends EntityPersistenceEventObserver {
  ...
  public void onSave(@Observes EntityNewEvent event) {
    ...
    if (Bpartner.getSSPRBirthday() != null) {
	      ...
	      String DocumentPartner = (Bpartner.getSSPRDocumentNo()!= null) ? Bpartner.getSSPRDocumentNo().toString():"";
	      ...
	      if (PartnerAge2.toString()!= null){
	          ...
	          final Entity BpartnerEntity = ModelProvider.getInstance().getEntity(
	          		BusinessPartner.ENTITY_NAME);
	          final Property valueProperty = BpartnerEntity
	              .getProperty(BusinessPartner.PROPERTY_SSHRAGE);
