...
public class ReportContractType extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocumentId = vars.getSessionValue("DB061BED6348461D9D11D24699BDF566|C_BPARTNER_ID");
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    ReportContractTypeData[] data = ReportContractTypeData.select(this, strDocumentId);
    if (log4j.isDebugEnabled())
      log4j.debug("data: " + (data == null ? "null" : "not null"));
    if (data == null || data.length == 0)
      data = ReportContractTypeData.set();

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("C_BPARTNER_ID", strDocumentId);

    String strReportName = "@basedesign@/com/sidesoft/hrm/payroll/reportcontracttype/ReportContractType.jrxml";
