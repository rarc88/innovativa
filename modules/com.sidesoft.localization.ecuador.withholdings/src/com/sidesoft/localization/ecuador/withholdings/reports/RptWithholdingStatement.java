...
public class RptWithholdingStatement extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(RptWithholdingStatement.class);
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    RptWithholdingStatementData[] data = RptWithholdingStatementData.select(this, strDocumentId);
    if (log4j.isDebugEnabled())
      log4j.debug("data: " + (data == null ? "null" : "not null"));
    if (data == null || data.length == 0)
      data = RptWithholdingStatementData.set();

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("DOCUMENT_ID", strDocumentId);

    String strReportName = "@basedesign@/com/sidesoft/localization/ecuador/withholdings/reports/RptWithholdingStatement.jrxml";
