 ...
 * ***********************************************************************
 */
package ec.com.sidesoft.custom.payment.partialpayment.ad_process;
...
public class Sescr_ReportPrintPayrollPartialPayment extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(Sescr_ReportPrintPayrollPartialPayment.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocumentId = vars
          .getSessionValue("FD76646320E84CEB8F243C1A6628020B|SCPP_PAYMENT_DETAIL_V_ID");
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    String StrWindowdID = "";
    String StrTableID = "";
    StrWindowdID = "FD76646320E84CEB8F243C1A6628020B";
    StrTableID = "DC962E28F8E2426DB8C0AD4BF8744B8D";
    String StrTransactionID = vars
        .getSessionValue("FD76646320E84CEB8F243C1A6628020B|SCPP_PAYMENT_DETAIL_V_ID");

    scpppaymentdetailv ScppPaymentDetailVID = OBDal.getInstance().get(scpppaymentdetailv.class,
        StrTransactionID);
    Organization ADOrg = OBDal.getInstance().get(Organization.class,
        ScppPaymentDetailVID.getOrganization().getId().toString());
