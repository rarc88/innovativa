...
public class Sescr_ReportPrintGoodsMovements extends HttpSecureAppServlet {
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    InternalMovement MMovementID = OBDal.getInstance()
        .get(InternalMovement.class, StrTransactionID);
    Organization ADOrg = OBDal.getInstance().get(Organization.class,
        MMovementID.getOrganization().getId().toString());
