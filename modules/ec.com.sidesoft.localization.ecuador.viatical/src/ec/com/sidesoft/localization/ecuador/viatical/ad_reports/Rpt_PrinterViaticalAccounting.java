...
public class Rpt_PrinterViaticalAccounting extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(Rpt_PrinterViaticalAccounting.class);
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: Rpt_PrinterViaticalAccounting - pdf");
    
    RptPrinterViaticalAccountingData[] data = RptPrinterViaticalAccountingData.select(this, strDocumentId);
    if (log4j.isDebugEnabled())
      log4j.debug("data: " + (data == null ? "null" : "not null"));
    if (data == null || data.length == 0)
      data = RptPrinterViaticalAccountingData.set();

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("DOCUMENT_ID", strDocumentId);

    String strReportName = "@basedesign@/ec/com/sidesoft/localization/ecuador/viatical/ad_reports/Rpt_PrinterViaticalAccounting.jrxml";
