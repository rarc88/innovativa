...
public class ReportPrintElectronicInvoice extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocumentId = vars.getSessionValue("167|C_INVOICE_ID");
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    ReportPrintElectronicInvoiceData[] data = ReportPrintElectronicInvoiceData.select(this, strDocumentId);
    if (log4j.isDebugEnabled())
    ...
    String strReportName = "@basedesign@/ec/cusoft/facturaec/ad_process/PrintElectronicDocuments/RptC_Invoice_Electronic.jrxml";
