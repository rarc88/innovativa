...
public class FileGenerationEcuador extends AbstractFileGeneration implements OBEInvoice_I,
  ...
  public String generateFile(Invoice invoice, String rootDirectory, String lang) throws Exception {
    ...
    for (InvoiceLine detalleObj : Lines) {
      ...
      subtotalInicialLinea = Double.parseDouble(formateador.format(detalleObj.getSsfiInitialSubtotal()).toString());
      double subtotalFinal = 0;  
      subtotalFinal = Double.parseDouble(formateador.format(detalleObj.getLineNetAmount()).toString());
    ...
    for (InvoiceLine detalleObj : lines) {
      ...
      double DescuentoLinea = 0;
      double subtotalInicialLinea = Double.parseDouble(formateador.format(detalleObj.getSsfiInitialSubtotal()).toString());
      double subtotalFinal = 0;
      subtotalFinal = Double.parseDouble(formateador.format(detalleObj.getLineNetAmount()).toString());
      if(subtotalInicialLinea>subtotalFinal) {
    	  DescuentoLinea = subtotalInicialLinea-subtotalFinal;
