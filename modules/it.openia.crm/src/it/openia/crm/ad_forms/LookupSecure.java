 ...
 * @author nicholas
 */
public class LookupSecure extends HttpSecureAppServlet {
    ...
    private void printPageDataSheet(HttpServletRequest request, HttpServletResponse response, VariablesSecureApp vars)
        ...
        try {
            // ArrayList<OptomHotel> hotels = HotelDAL.getHotels();
            // request.setAttribute("hotels", hotels);

            RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/web/it.openia.crm/list.jsp");
    ...
    public String getServletInfo() {
        return "Openia Crm Lookup Table Servlet. Still under development";
