 ...
 *************************************************************************
 */
package com.sidesoft.flopec.budget.ad_actionbutton;
...
public class BudgetExecutePayments extends HttpSecureAppServlet {
  ...
  private static final String BudgetPaymentOutWindow = "5BE1F75DD7234788AEA37D254B6769F7";
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (vars.commandIn("DEFAULT")) {
      final String strWindowId = vars.getGlobalVariable("inpwindowId",
          "BudgetExecutePayments|Window_ID", IsIDFilter.instance);
      String strTabId = vars.getGlobalVariable("inpTabId", "BudgetExecutePayments|Tab_ID", "",
          IsIDFilter.instance);
      ...
      final String strWindowId = vars.getGlobalVariable("inpwindowId",
          "BudgetExecutePayments|Window_ID", IsIDFilter.instance);
      final String payments = vars.getSessionValue("BudgetExecutePayments|payments");
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars,
    ...
    XmlDocument xmlDocument = xmlEngine.readXmlTemplate(
        "com/sidesoft/flopec/budget/ad_actionbutton/BudgetExecutePayments").createXmlDocument();
    ...
    OBError myMessage = vars.getMessage("BudgetExecutePayments|message");
    vars.removeMessage("BudgetExecutePayments|message");
    if (myMessage != null) {
  ...
  private void processAndClose(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (PaymentInWindow.equals(strWindowId) || PaymentOutWindow.equals(strWindowId)
        || BudgetPaymentOutWindow.equals(strWindowId)
      ...
      final String strTabId = vars.getGlobalVariable("inpTabId", "BudgetExecutePayments|Tab_ID");
    ...
    vars.removeSessionValue("BudgetExecutePayments|Window_ID");
    vars.removeSessionValue("BudgetExecutePayments|Tab_ID");
    vars.removeSessionValue("BudgetExecutePayments|payments");
    if (PurchaseInvoiceWindow.equals(strWindowId) || SalesInvoiceWindow.equals(strWindowId))
      vars.removeSessionValue("BudgetExecutePayments|Org_ID");
  ...
  private PaymentExecutionProcess getExecutionProcess(VariablesSecureApp vars, String strWindowId)
    ...
    if (PaymentInWindow.equals(strWindowId) || PaymentOutWindow.equals(strWindowId)
      ...
      String strSelectedPaymentsIds = vars.getSessionValue("BudgetExecutePayments|payments");
  ...
  private String getOrganization(VariablesSecureApp vars, String strWindowId)
    ...
    if (PaymentInWindow.equals(strWindowId) || PaymentOutWindow.equals(strWindowId)
      ...
      return vars.getSessionValue("BudgetExecutePayments|Org_ID");
    }
    return null;
  }
  ...
  private void setPaymentsInSession(VariablesSecureApp vars, String strWindowId)
    ...
    if (!PurchaseInvoiceWindow.equals(strWindowId) && !SalesInvoiceWindow.equals(strWindowId))
      vars.setSessionValue("BudgetExecutePayments|payments", payments);
  }
