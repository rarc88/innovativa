...
public class Rpt_FinalSettlement extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(Rpt_FinalSettlement.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strDocumentId = vars.getSessionValue("3F0BFA1E7F2643CD84E05BA6BDA8220D|SSPR_SETTLEMENT_ID");
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (log4j.isDebugEnabled())
      log4j.debug("Output: Rpt_FinalSetlement - pdf");

    RptFinalSettlementData[] data = RptFinalSettlementData.select(this, strDocumentId);
    if (log4j.isDebugEnabled())
      log4j.debug("data: " + (data == null ? "null" : "not null"));
    if (data == null || data.length == 0)
      data = RptFinalSettlementData.set();

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("DOCUMENT_ID", strDocumentId);

    String strReportName = "@basedesign@/com/sidesoft/hrm/payroll/ad_Reports/Rpt_FinalSettlement.jrxml";
