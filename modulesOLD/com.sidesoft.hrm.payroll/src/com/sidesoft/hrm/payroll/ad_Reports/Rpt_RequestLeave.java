...
public class Rpt_RequestLeave extends HttpSecureAppServlet {
  private static Logger log4j = Logger.getLogger(Rpt_RequestLeave.class);
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    RptRequestLeaveData[] data = RptRequestLeaveData.select(this, strDocumentId);
    if (log4j.isDebugEnabled())
      log4j.debug("data: " + (data == null ? "null" : "not null"));
    if (data == null || data.length == 0)
      data = RptRequestLeaveData.set();

    HashMap<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("DOCUMENT_ID", strDocumentId);

    String strReportName = "@basedesign@/com/sidesoft/hrm/payroll/ad_Reports/Rpt_RequestLeave.jrxml";
