 ...
 ************************************************************************
 */
package ec.com.sidesoft.partnerinfo.complement.ad_callouts;
...
public class SE_Invoice_BPartner extends SimpleCallout {
  ...
  protected void execute(CalloutInfo info) throws ServletException {
    ...
    // Inicio Ticket: 5131 -RJ -2019/03/21
    BusinessPartner contractobj = OBDal.getInstance().get(BusinessPartner.class, strBPartner);
    info.addResult("inpemSpincoTaxid", contractobj.getTaxID());

    // Fin Ticket: 5131 -RJ -2019/03/21
