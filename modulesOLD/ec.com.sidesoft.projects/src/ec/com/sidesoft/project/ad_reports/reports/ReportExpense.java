 ...
 ************************************************************************
 */
package ec.com.sidesoft.project.ad_reports.reports;
...
public class ReportExpense extends HttpSecureAppServlet {
  ...
  private void printPageDataHtml(HttpServletRequest request, HttpServletResponse response,
    ...
    if (vars.commandIn("DEFAULT") && strDateFrom.equals("") && strDateTo.equals("")
      ...
      try {
        data1 = ReportExpenseData.select(this, strCurrencyId, strBaseCurrencyId, vars.getLanguage(),
            Utility.getContext(this, vars, "#User_Client", "ReportExpense"),
    ...
    for (int i = 0; i < data1.length; i++) {
      if (data1[i].horas != null && !data1[i].horas.equals("") && !data1[i].horas.trim().equals("0")
          && data1[i].cuomid != null && !data1[i].cuomid.equals("")) {
    ...
    if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      xmlDocument = xmlEngine
          .readXmlTemplate("ec/com/sidesoft/project/ad_reports/reports/ReportExpenseEdit")
          .createXmlDocument();
  ...
  private void printPageDataPDF(HttpServletRequest request, HttpServletResponse response,
    ...
    if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      String strReportName = "@basedesign@/ec/com/sidesoft/project/ad_reports/reports/ReportExpense.jrxml";
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    xmlDocument = xmlEngine
        .readXmlTemplate("ec/com/sidesoft/project/ad_reports/reports/ReportExpense")
        .createXmlDocument();
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "ec.com.sidesoft.project.ad_reports.reports.ReportExpense");
