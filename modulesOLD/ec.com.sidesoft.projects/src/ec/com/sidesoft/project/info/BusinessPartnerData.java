...
package ec.com.sidesoft.project.info;
...
class BusinessPartnerData implements FieldProvider {
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("rn1"))
      ...
      return nameHidden;
    else if (fieldName.equalsIgnoreCase("so_creditavailable")
        || fieldName.equals("soCreditavailable"))
      ...
      return contact;
    else if (fieldName.equalsIgnoreCase("c_bpartner_contact_id")
        || fieldName.equals("cBpartnerContactId"))
  ...
  public static BusinessPartnerData[] select(ConnectionProvider connectionProvider, String rownum,
      String adUserClient, String adUserOrg, String key, String name, String contact,
      String codigoPostal, String provincia, String clients, String vendors, String ciudad,
      String orderBy, String pgLimit, String oraLimit1, String oraLimit2) throws ServletException {
    return select(connectionProvider, rownum, adUserClient, adUserOrg, key, name, contact,
        codigoPostal, provincia, clients, vendors, ciudad, orderBy, pgLimit, oraLimit1, oraLimit2,
        0, 0);
  }
  ...
  public static BusinessPartnerData[] select(ConnectionProvider connectionProvider, String rownum,
      String adUserClient, String adUserOrg, String key, String name, String contact,
      String codigoPostal, String provincia, String clients, String vendors, String ciudad,
      String orderBy, String pgLimit, String oraLimit1, String oraLimit2, int firstRegister,
    ...
    strSql = strSql + ") " + "					        AND bp.AD_Org_ID IN (";
    ...
    strSql = strSql + ") "
        ...
        + "					        AND bp.IsSummary='N' "
        + "					        AND bp.IsActive='Y'";
    strSql = strSql + ((key == null || key.equals("") || key.equals("%")) ? ""
        : " AND UPPER(bp.Value) LIKE UPPER(?)  ");
    strSql = strSql + ((name == null || name.equals("") || name.equals("%")) ? ""
        : " AND C_IGNORE_ACCENT(bp.Name) LIKE C_IGNORE_ACCENT(?)  ");
    strSql = strSql + ((contact == null || contact.equals("") || contact.equals("%")) ? ""
        : " AND UPPER(u.name) LIKE UPPER(?)  ");
    strSql = strSql
        + ((codigoPostal == null || codigoPostal.equals("") || codigoPostal.equals("%")) ? ""
            : " AND UPPER(l.Postal) LIKE UPPER(?)  ");
    strSql = strSql + ((provincia == null || provincia.equals("") || provincia.equals("%")) ? ""
        : " AND UPPER(r.NAME) LIKE UPPER(?) ");
    strSql = strSql + ((clients.equals("clients")) ? " AND ISCUSTOMER = 'Y'  " : "");
    strSql = strSql + ((vendors.equals("vendors")) ? " AND ISVENDOR ='Y' " : "");
    strSql = strSql + ((ciudad == null || ciudad.equals("") || ciudad.equals("%")) ? ""
    ...
    strSql = strSql + ") B" + "			WHERE 1=1";
    strSql = strSql
        + ((oraLimit2 == null || oraLimit2.equals("")) ? "" : " AND RN1 BETWEEN " + oraLimit2);
    ...
    try {
      ...
      if (contact != null && !(contact.equals("")) && !(contact.equals("%"))) {
        iParameter++;
        UtilSql.setValue(st, iParameter, 12, null, contact);
      }
      if (codigoPostal != null && !(codigoPostal.equals("")) && !(codigoPostal.equals("%"))) {
        iParameter++;
        UtilSql.setValue(st, iParameter, 12, null, codigoPostal);
      }
      if (provincia != null && !(provincia.equals("")) && !(provincia.equals("%"))) {
        iParameter++;
        UtilSql.setValue(st, iParameter, 12, null, provincia);
      }
      ...
      if (ciudad != null && !(ciudad.equals("")) && !(ciudad.equals("%"))) {
        iParameter++;
        UtilSql.setValue(st, iParameter, 12, null, ciudad);
      }
      ...
      while (continueResult && result.next()) {
        ...
        objectBusinessPartnerData.soCreditavailable = UtilSql.getValue(result,
            "so_creditavailable");
        ...
        objectBusinessPartnerData.cBpartnerContactId = UtilSql.getValue(result,
        ...
        objectBusinessPartnerData.cBpartnerLocationId = UtilSql.getValue(result,
  ...
  public static String countRows(ConnectionProvider connectionProvider, String rownum,
      String adUserClient, String adUserOrg, String key, String name, String contact,
      String codigoPostal, String provincia, String clients, String vendors, String ciudad,
    ...
    strSql = strSql + ") "
        + "	        AND (u.isactive is null OR u.isactive='Y') and (u.c_bpartner_location_id is null or u.c_bpartner_location_id = bpl.C_BPartner_Location_ID)"
        + "	        AND bp.IsSummary='N' " + "	        AND bp.IsActive='Y'";
    strSql = strSql + ((key == null || key.equals("") || key.equals("%")) ? ""
        : " AND UPPER(bp.Value) LIKE UPPER(?)  ");
    strSql = strSql + ((name == null || name.equals("") || name.equals("%")) ? ""
        : " AND C_IGNORE_ACCENT(bp.Name) LIKE C_IGNORE_ACCENT(?)  ");
    ...
    strSql = strSql + "	        ) A ";
    strSql = strSql
        + ((oraLimit2 == null || oraLimit2.equals("")) ? "" : " WHERE RN1 BETWEEN " + oraLimit2);
  ...
  public static BusinessPartnerData[] selectKey(ConnectionProvider connectionProvider,
      String adUserClient, String adUserOrg, String clients, String vendors, String key,
      String pgLimit, String oraLimit1) throws ServletException {
    return selectKey(connectionProvider, adUserClient, adUserOrg, clients, vendors, key, pgLimit,
        oraLimit1, 0, 0);
  }

  public static BusinessPartnerData[] selectKey(ConnectionProvider connectionProvider,
      String adUserClient, String adUserOrg, String clients, String vendors, String key,
      String pgLimit, String oraLimit1, int firstRegister, int numberRegisters)
    ...
    strSql = strSql + ((clients.equals("clients")) ? " AND ISCUSTOMER = 'Y'  " : "");
    strSql = strSql + ((vendors.equals("vendors")) ? " AND ISVENDOR ='Y' " : "");
    strSql = strSql + "        AND UPPER(bp.VALUE) LIKE UPPER(?)" + "        ORDER BY bp.name";
    strSql = strSql + ((pgLimit == null || pgLimit.equals("")) ? "" : " LIMIT " + pgLimit);
    strSql = strSql + "      ) A ";
    strSql = strSql
        + ((oraLimit1 == null || oraLimit1.equals("")) ? "" : "  WHERE ROWNUM <= " + oraLimit1);
  ...
  public static String existsActual(ConnectionProvider connectionProvider, String description,
      String cBpartnerId) throws ServletException {
    String strSql = "";
    strSql = strSql + "        SELECT bp.name as name" + "        FROM C_BPARTNER bp "
        + "        WHERE UPPER(bp.name) = UPPER(?)" + "        AND bp.C_BPartner_ID = ? "
        + "        ORDER BY bp.name";
  ...
  public static String existsActualValue(ConnectionProvider connectionProvider, String description,
      String cBpartnerId) throws ServletException {
    String strSql = "";
    strSql = strSql + "        SELECT bp.value as value" + "        FROM C_BPARTNER bp "
        + "        WHERE UPPER(bp.name) = UPPER(?)" + "        AND bp.C_BPartner_ID = ? "
        + "        ORDER BY bp.value";
