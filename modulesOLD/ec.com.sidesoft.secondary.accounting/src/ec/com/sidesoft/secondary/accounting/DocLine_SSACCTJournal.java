...
public class DocLine_SSACCTJournal extends DocLine {
  static Logger log4jDocLine_GLJournal = Logger.getLogger(DocLine_SSACCTJournal.class);

  public DocLine_SSACCTJournal(String DocumentType, String TrxHeader_ID, String TrxLine_ID) {
