...
public class ReportGeneralLedgerSecondary extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strcElementId = vars.getRequestGlobalVariable("inpElementId",
          "ReportGeneralLedgerSecondary|inpElementId");

      String strOrg = vars.getGlobalVariable("inpOrg", "ReportGeneralLedgerSecondary|Org",
          vars.getOrg());
      if (StringUtils.isEmpty(strcElementId)) {
        ReportTrialBalanceData[] trialBalanceDatas = ReportTrialBalanceData.selectElemetdefault(
            readOnlyCP, vars.getClient());
        strcElementId = trialBalanceDatas[0].elementId;
      }

      String strDateFrom = vars.getGlobalVariable("inpDateFrom",
          "ReportGeneralLedgerSecondary|DateFrom", "");
      String strDateTo = vars.getGlobalVariable("inpDateTo", "ReportGeneralLedgerSecondary|DateTo",
          "");
      String strPageNo = vars.getGlobalVariable("inpPageNo", "ReportGeneralLedgerSecondary|PageNo",
          "1");
      String strAmtFrom = vars.getNumericGlobalVariable("inpAmtFrom",
          "ReportGeneralLedgerSecondary|AmtFrom", "");
      String strAmtTo = vars.getNumericGlobalVariable("inpAmtTo",
          "ReportGeneralLedgerSecondary|AmtTo", "");
      String strcelementvaluefrom = vars.getGlobalVariable("inpcElementValueIdFrom",
          "ReportGeneralLedgerSecondary|C_ElementValue_IDFROM", "");
      String strcelementvalueto = vars.getGlobalVariable("inpcElementValueIdTo",
          "ReportGeneralLedgerSecondary|C_ElementValue_IDTO", "");
      ...
      String strcBpartnerId = vars.getInGlobalVariable("inpcBPartnerId_IN",
          "ReportGeneralLedgerSecondary|cBpartnerId", "", IsIDFilter.instance);
      String strmProductId = vars.getInGlobalVariable("inpmProductId_IN",
          "ReportGeneralLedgerSecondary|mProductId", "", IsIDFilter.instance);
      String strcProjectId = vars.getInGlobalVariable("inpcProjectId_IN",
          "ReportGeneralLedgerSecondary|cProjectId", "", IsIDFilter.instance);
      String strGroupBy = vars.getGlobalVariable("inpGroupBy",
          "ReportGeneralLedgerSecondary|GroupBy", "");
      String strShowOpenBalances = vars.getGlobalVariable("inpShowOpenBalances",
          "ReportGeneralLedgerSecondary|showOpenBalances", "");
      printPageDataSheet(response, vars, strDateFrom, strDateTo, strPageNo, strAmtFrom, strAmtTo,
          ...
          strcProjectId, strGroupBy, strcElementId, strcelementvaluefromdes, strcelementvaluetodes,
          strShowOpenBalances);
      ...
      String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom",
          "ReportGeneralLedgerSecondary|DateFrom");
      vars.setSessionValue("ReportGeneralLedgerSecondary|inpElementId", strcElementId);
      String strDateTo = vars.getRequestGlobalVariable("inpDateTo",
          "ReportGeneralLedgerSecondary|DateTo");
      String strPageNo = vars.getRequestGlobalVariable("inpPageNo",
          "ReportGeneralLedgerSecondary|PageNo");
      String strAmtFrom = vars.getNumericParameter("inpAmtFrom");
      vars.setSessionValue("ReportGeneralLedgerSecondary|AmtFrom", strAmtFrom);
      String strAmtTo = vars.getNumericParameter("inpAmtTo");
      vars.setSessionValue("ReportGeneralLedgerSecondary|AmtTo", strAmtTo);
      ...
      String strShowOpenBalances = vars.getRequestGlobalVariable("inpShowOpenBalances",
          "ReportGeneralLedgerSecondary|showOpenBalances");
      String strOrg = vars.getGlobalVariable("inpOrg", "ReportGeneralLedgerSecondary|Org", "0");
      ...
      vars.setSessionValue("ReportGeneralLedgerSecondary.initRecordNumber", "0");
      printPageDataSheet(response, vars, strDateFrom, strDateTo, strPageNo, strAmtFrom, strAmtTo,
          strcelementvaluefrom, strcelementvalueto, strOrg, strcBpartnerId, strmProductId,
          strcProjectId, strGroupBy, strcElementId, strcelementvaluefromdes, strcelementvaluetodes,
          strShowOpenBalances);
      ...
      ConnectionProvider readOnlyCP = DalConnectionProvider.getReadOnlyConnectionProvider();
      String strInitRecord = vars.getSessionValue("ReportGeneralLedgerSecondary.initRecordNumber");
      String strRecordRange = Utility.getContext(readOnlyCP, vars, "#RecordRange",
          "ReportGeneralLedgerSecondary");
      ...
      if (StringUtils.isEmpty(strInitRecord) || StringUtils.equals(strInitRecord, "0")) {
        ...
        vars.setSessionValue("ReportGeneralLedgerSecondary.initRecordNumber", strInitRecord);
      }
      ...
      String strcAcctSchemaId = vars.getRequestGlobalVariable("inpElementId",
          "ReportGeneralLedgerSecondary|cElementId");
      String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom",
          "ReportGeneralLedgerSecondary|DateFrom");
      String strDateTo = vars.getRequestGlobalVariable("inpDateTo",
          "ReportGeneralLedgerSecondary|DateTo");
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
      ...
      String strmProductId, String strcProjectId, String strGroupBy, String strcElementId,
    ...
    ToolBar toolbar = new ToolBar(readOnlyCP, vars.getLanguage(), "ReportGeneralLedgerSecondary",
        true, "", "", "imprimir();return false;", false, "ad_reports", strReplaceWith, false, true);
    ...
    if (StringUtils.isEmpty(strDateFrom) && StringUtils.isEmpty(strDateTo)) {
      ...
      xmlDocument = xmlEngine.readXmlTemplate(
          "ec/com/sidesoft/secondary/accounting/ad_reports/ReportGeneralLedgerSecondary", discard)
          .createXmlDocument();
      toolbar
          .prepareRelationBarTemplate(
              false,
              false,
              "submitCommandForm('XLS', false, frmMain, 'ReportGeneralLedgerExcelSecondary.xls', 'EXCEL');return false;");
      ...
      try {
        scroll = ReportGeneralLedgerData.select2(readOnlyCP, rowNum, strGroupByText, strGroupBy,
            strAllaccounts, strcelementvaluefrom, localStrcelementvalueto, Utility.getContext(
                readOnlyCP, vars, "#AccessibleOrgTree", "ReportGeneralLedgerSecondary"), Utility
                .getContext(readOnlyCP, vars, "#User_Client", "ReportGeneralLedgerSecondary"),
            StringUtils.equals(strShowOpenBalances, "Y") ? strDateTo : null, strDateFrom,
          ...
          if (i == 0 && initRecordNumber > 0) {
            ...
            dataTotal = ReportGeneralLedgerData.select2Total(readOnlyCP, rowNum, strGroupByText,
                strGroupBy, strAllaccounts, strcelementvaluefrom, localStrcelementvalueto, Utility
                    .getContext(readOnlyCP, vars, "#AccessibleOrgTree",
                        "ReportGeneralLedgerSecondary"), Utility.getContext(readOnlyCP, vars,
                    "#User_Client", "ReportGeneralLedgerSecondary"), "", DateTimeData.nDaysAfter(
                    readOnlyCP, data[0].dateacct, "1"), strOrgFamily, strcBpartnerId,
                strmProductId, strcProjectId, strAmtFrom, strAmtTo, data[0].id, data[0].groupbyid,
                null, null, null, data[0].dateacctnumber + data[0].factaccttype
                    + data[0].factAcctGroupId + data[0].ssacctFactacctsecondaryId);
            dataSubtotal = ReportGeneralLedgerData.select2sum(readOnlyCP, rowNum, strGroupByText,
                strGroupBy, strAllaccounts, strcelementvaluefrom, localStrcelementvalueto, Utility
                    .getContext(readOnlyCP, vars, "#AccessibleOrgTree",
                        "ReportGeneralLedgerSecondary"), Utility.getContext(readOnlyCP, vars,
                    "#User_Client", "ReportGeneralLedgerSecondary"), strDateFrom, toDatePlusOne,
                strOrgFamily, (StringUtils.equals(strGroupBy, "BPartner") ? "('"
                    + data[i].groupbyid + "')" : strcBpartnerId), (StringUtils.equals(strGroupBy,
                    "Product") ? "('" + data[i].groupbyid + "')" : strmProductId), (StringUtils
                    .equals(strGroupBy, "Project") ? "('" + data[i].groupbyid + "')"
                    : strcProjectId), strAmtFrom, strAmtTo, null, null, null, null, null,
                data[0].dateacctnumber + data[0].factaccttype + data[0].factAcctGroupId
                    + data[0].ssacctFactacctsecondaryId, data[0].id);
            ...
            if (StringUtils.isEmpty(data[i].groupbyid)) {
              ...
              subreportElement = ReportGeneralLedgerData.selectTotal2(readOnlyCP, strcBpartnerId,
                  ...
                  (StringUtils.equals(strGroupBy, "Project") ? " " : null), data[i].id, "",
        ...
        if (!StringUtils.equals(strTotal, (data[i].groupbyid + data[i].id))) {
          ...
          if (StringUtils.isEmpty(data[i].groupbyid)) {
            ...
            subreportElement = ReportGeneralLedgerData.selectTotal2(readOnlyCP,
                ...
                null, data[i].id, "", toDatePlusOne, strOrgFamily);
            log4j.debug("SelectTotal2. Time in mils: " + (System.currentTimeMillis() - init));
          }
        }
      ...
      toolbar
          .prepareRelationBarTemplate(
              hasPrevious,
              hasNext,
              "submitCommandForm('XLS', true, frmMain, 'ReportGeneralLedgerExcelSecondary.xls', 'EXCEL');return false;");
      xmlDocument = xmlEngine.readXmlTemplate(
          "/ec/com/sidesoft/secondary/accounting/ad_reports/ReportGeneralLedgerSecondary", discard)
          .createXmlDocument();
    }
    ...
    try {
      WindowTabs tabs = new WindowTabs(readOnlyCP, vars,
          "ec.com.sidesoft.secondary.accounting.ad_reports.ReportGeneralLedgerSecondary");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(readOnlyCP, vars.getLanguage(),
          "ReportGeneralLedgerSecondary.html", classInfo.id, classInfo.type, strReplaceWith,
          tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(readOnlyCP, vars.getLanguage(),
          "ReportGeneralLedgerSecondary.html", strReplaceWith);
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, readOnlyCP, "TABLEDIR", "AD_ORG_ID",
          "", "",
          Utility.getContext(readOnlyCP, vars, "#User_Org", "ReportGeneralLedgerSecondary"),
          Utility.getContext(readOnlyCP, vars, "#User_Client", "ReportGeneralLedgerSecondary"), '*');
      comboTableData.fillParameters(null, "ReportGeneralLedgerSecondary", "");
    ...
    xmlDocument.setParameter("cAcctschemaId", strcElementId);
    ...
    xmlDocument.setData("reportC_ACCTSCHEMA_ID", "liststructure",
        ReportTrialBalanceData.selectElemetCollection(readOnlyCP, vars.getClient()));
  ...
  private void printPageDataPDF(HttpServletRequest request, HttpServletResponse response,
    ...
    try {
      ...
      String strReportName = "@basedesign@/ec/com/sidesoft/secondary/accounting/ad_reports/ReportGeneralLedgerSecondary.jrxml";
      response.setHeader("Content-disposition",
          "inline; filename=ReportGeneralLedgerPDFSecondary.pdf");
  ...
  private void printPageDataXLS(HttpServletRequest request, HttpServletResponse response,
    ...
    try {
      data = ReportGeneralLedgerData.selectXLS2(readOnlyCP, strAllaccounts, strcelementvaluefrom,
          localStrcelementvalueto, Utility.getContext(readOnlyCP, vars, "#AccessibleOrgTree",
              "ReportGeneralLedgerSecondary"), Utility.getContext(readOnlyCP, vars, "#User_Client",
              "ReportGeneralLedgerSecondary"),
          StringUtils.equals(strShowOpenBalances, "Y") ? strDateTo : null, strDateFrom,
          toDatePlusOne, strOrgFamily, strcBpartnerId, strmProductId, strcProjectId, strAmtFrom,
          strAmtTo);
      ...
      String strReportName = "@basedesign@/ec/com/sidesoft/secondary/accounting/ad_reports/ReportGeneralLedgerExcelSecondary.jrxml";
      ...
      if (!StringUtils.equals(strOld, (cur.groupbyid + cur.id))) {
        if (StringUtils.isEmpty(cur.groupbyid)) {
          ...
          subreport = ReportGeneralLedgerData.selectTotal2(conn, strcBpartnerId,
              (StringUtils.equals(strGroupBy, "BPartner") ? " " : null), strmProductId,
              (StringUtils.equals(strGroupBy, "Product") ? " " : null), strcProjectId,
              (StringUtils.equals(strGroupBy, "Project") ? " " : null), cur.id, "", strDateFrom,
              strOrgFamily);
        } else {
          subreport = ReportGeneralLedgerData.selectTotal2(conn, (StringUtils.equals(strGroupBy,
              ...
              (StringUtils.equals(strGroupBy, "Project") ? "('" + cur.groupbyid + "')"
                  : strcProjectId), null, cur.id, "", strDateFrom, strOrgFamily);
        }
