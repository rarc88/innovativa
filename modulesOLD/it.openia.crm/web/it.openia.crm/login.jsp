...
<html>
    <head> 
        ...
        <link rel="stylesheet" href="../web/it.openia.crm/source/login.css" type="text/css">

        <script src='../web/it.openia.crm/js/jquery-1.8.1.min.js' type='text/javascript'></script>
    ...
    <div class="enyo-unselectable">
        <script type="text/javascript">
            new Login({fit:true}).renderInto(document.body);
        </script>
    </div>
