...
<html>
	...
	<link rel="stylesheet" type='text/css' href="../web/it.openia.crm/css/jquery.smallipop.css" media="all" title="Screen">
        ...
        <div id="activitydialog" evt_id="" style="background: rgb(234, 245, 214);font-size: 16px;">
            ...
            <div id="eventDiv">
                <center>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><span><input type="text" name="info_attivita" placeholder="nome" autofocus></span>
                                <a style="padding-bottom: 5px;padding-left: 5px;" href="#" onclick="" id="actOBLink" target="_blank">
                        ...
                        <tr id="LeadSelect">
                            <td style="width:253px;height:37px;"><span>Lead:</span></td>  <td><span>
                    ...
                    <button id="evtSaveBtn" title="<%=GetEvents.GetMessage("OPCRM_SAVEACT")%>" type="button" style="cursor: hand; cursor: pointer;heigth:33px;width:46px;"><img src="../web/it.openia.crm/images/disk.png"/>
                    </button>
                    </a>    
                    &nbsp;&nbsp;
                    <a class="userPopUpInfo" href="#" title="<%=GetEvents.GetMessage("OPCRM_DELETEACT")%>">
                    <button id="evtDeleteBtn" title="<%=GetEvents.GetMessage("OPCRM_DELETEACT")%>" type="button" style="cursor: hand; cursor: pointer;heigth:33px;width:46px;"><img src="../web/it.openia.crm/images/delete.png"/>
                    </button>
                    </a>
                    &nbsp;&nbsp;
                    <a class="userPopUpInfo" href="#" title="<%=GetEvents.GetMessage("OPCRM_NEXTACT")%>">
                    <button id="evtRescheduleBtn" title="<%=GetEvents.GetMessage("OPCRM_NEXTACT")%>" type="button" style="cursor: hand; cursor: pointer;heigth:33px;width:46px;"><img src="../web/it.openia.crm/images/calendar_edit.png"/>
                    </button>
                    </a>    
                    &nbsp;&nbsp;
                    <a class="userPopUpInfo" href="#" title="<%=GetEvents.GetMessage("OPCRM_SETASDONE")%>">
                    <button id="evtDoneAndNextBtn" title="<%=GetEvents.GetMessage("OPCRM_SETASDONE")%>" type="button" style="cursor: hand; cursor: pointer;heigth:33px;width:46px;"><img src="../web/it.openia.crm/images/date_go.png"/>
                    </button>
                    </a>    
                </center>    
            </div>
