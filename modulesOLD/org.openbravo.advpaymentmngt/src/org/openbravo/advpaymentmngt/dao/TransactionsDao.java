    ...
    try {
      ...
      for (int i = 0; i < data.length; i++) {
        ...
        if (FIN_Transactions[i].getFinPayment() != null) {
          ...
          strPaymentNReferencia = FIN_Transactions[i].getFinPayment().getReferenceNo();
        }
        ...
        FieldProviderFactory.setField(data[i], "paymentReference", strPaymentNReferencia);
