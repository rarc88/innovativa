...
public class SS_Vacancies extends HttpSecureAppServlet 
{
...
//recibe la llamada al servelet
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException 
  {
    ...
    if (vars.commandIn("DEFAULT")) 
    {
      ...
      String strReason = vars.getStringParameter("inpsshrPositionTitleId");
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strReason) throws IOException, ServletException 
  {
    ...
    SSVacanciesData[] data = SSVacanciesData.select(this, strReason);
    StringBuffer resultado = new StringBuffer();
    
    resultado.append("var calloutName='SS_Vacancies';\n\n");
    resultado.append("var respuesta = new Array(");
    if (data != null && data.length > 0) 
    {
		resultado.append("new Array(\"inpnovacancies\", \"" + data[0].vacancies + "\")\n");
