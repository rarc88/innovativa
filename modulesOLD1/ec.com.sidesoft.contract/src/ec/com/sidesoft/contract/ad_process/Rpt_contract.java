package ec.com.sidesoft.contract.ad_process;
...
public class Rpt_contract extends HttpSecureAppServlet {
  ...
  private static Logger log4j1 = Logger.getLogger(Rpt_contract.class);
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    strSessionValue = "240FE3FCD7904F84B731EDB285FEC5DC|SSCT_CONTRACT_ID";
    StrWindowdID = "240FE3FCD7904F84B731EDB285FEC5DC";
    StrTableID = "D88530FEAC234526B508037E8CA59658";
  ...
  private void printPagePDF(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (LstTemplate.get(0).getWindow().getId().equals(StrWindowdID)) {
      ...
      if (log4j1.isDebugEnabled())
        log4j1.debug("Output: Rpt_contract - pdf");
      ...
      parameters.put("BASE_DIR", StrRutaReport);
