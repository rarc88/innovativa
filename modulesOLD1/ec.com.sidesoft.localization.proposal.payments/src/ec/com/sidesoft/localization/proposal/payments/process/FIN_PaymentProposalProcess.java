    ...
    try {
      ...
      if (strAction.equals("GSP") || strAction.equals("GONEP")) {
        ...
        try {
           ...
           * parameters.add(vars.getClient()); parameters.add(orgId.getId());
           * parameters.add(isReceipt ? "ARR" : "APP"); String strDocTypeId = (String)
           * CallStoredProcedure.getInstance().call("AD_GET_DOCTYPE", parameters, null);
           */

          if (paymentProposal.getSlppPaymentDoctype() == null) {
            throw new OBException("@Slpp_Doctype_Not_Found@");
          }
          String strDocTypeId = paymentProposal.getSlppPaymentDoctype().getId();
          ...
          for (FIN_PaymentPropDetail paymentProposalDetail : selectedPaymentProposalDetails) {
            ...
            if (groupByVendor && !strBusinessPartner_old.equals(strBusinessPartner)
              ...
              FIN_Payment payment = FIN_AddPayment.savePayment(null, isReceipt,
                  ...
                  strPaymentDocumentNo, selectedPaymentDetails, selectedPaymentDetailsAmounts,
          ...
          FIN_Payment payment = FIN_AddPayment.savePayment(null, isReceipt,
              ...
              paymentDate, orgId, strPaymentDocumentNo, selectedPaymentDetails,
