...
public class ReportProjectBuildingSiteJR extends HttpSecureAppServlet {
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (vars.commandIn("DEFAULT")) {
      xmlDocument = xmlEngine
          .readXmlTemplate("ec/com/sidesoft/project/ad_reports/reports/ReportProjectBuildingSiteJR")
          .createXmlDocument();
      ...
      try {
        WindowTabs tabs = new WindowTabs(this, vars,
            "ec.com.sidesoft.project.ad_reports.reports.ReportProjectBuildingSiteJR");
      ...
      if (data == null || data.length == 0) {
        xmlDocument = xmlEngine
            .readXmlTemplate(
                "ec/com/sidesoft/project/ad_reports/reports/ReportProjectBuildingSiteJR", discard)
            .createXmlDocument();
  ...
  private void printPageDataPDF(HttpServletRequest request, HttpServletResponse response,
    ...
    if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      String strReportName = "@basedesign@/ec/com/sidesoft/project/ad_reports/reports/ReportProjectBuildingSiteJR.jrxml";
