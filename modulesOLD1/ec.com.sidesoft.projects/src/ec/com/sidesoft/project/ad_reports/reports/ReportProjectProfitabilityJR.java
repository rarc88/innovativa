...
public class ReportProjectProfitabilityJR extends HttpSecureAppServlet {
  ...
  private void printPageDataHtml(HttpServletRequest request, HttpServletResponse response,
    ...
    if (!strConvRateErrorMsg.equals("") && strConvRateErrorMsg != null) {
      ...
      String strReportName = "@basedesign@/ec/com/sidesoft/project/ad_reports/reports/ReportProjectProfitabilityJR.jrxml";
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    xmlDocument = xmlEngine
        .readXmlTemplate("ec/com/sidesoft/project/ad_reports/reports/ReportProjectProfitabilityJR")
        .createXmlDocument();
    ...
    try {
      WindowTabs tabs = new WindowTabs(this, vars,
          "ec.com.sidesoft.project.ad_reports.reports.ReportProjectProfitabilityJR");
