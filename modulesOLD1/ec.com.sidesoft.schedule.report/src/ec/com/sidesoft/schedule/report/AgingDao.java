...
public class AgingDao {
  ...
  public FieldProvider[] getOpenReceivablesAgingSchedule(ConnectionProvider connectionProvider,
    ...
    try {
      ...
      while (dataSR.next()) {
        ...
        final String strCName = dd.cName;
        final String strUSName = dd.usName;
        ...
        if (agingBalanceData.containsKey(strBusinessPartnerId)) {
          ...
          agingBalanceData.put(strBusinessPartnerId, new AgingData(strBusinessPartnerId, strBpName,
              strCName, strUSName, psdAmt, intScope));
        }
    ...
    try {
      ...
      while (dataSR.next()) {
        ...
        HashMap<String, String> psData = insertData(docNo, invoiceId, invoiceDate, amount,
            ...
            dateFormat, false, doubtfulDebtAmount, strCName, strUSName);
  ...
  private HashMap<String, String> insertData(String documentNo, String id, Date date,
      ...
      SimpleDateFormat dateFormat, boolean credits, BigDecimal doubtfulDebt, String cName,
      String usName) {
    HashMap<String, String> psData = new HashMap<String, String>();
    psData.put("INVOICE_NUMBER", documentNo);
    psData.put("CNAME", cName);
    psData.put("USNAME", usName);
  ...
  private void setFieldsIntoFieldProvider(FieldProvider[] data, List<AgingData> agingBalanceData) {
    for (int i = 0; i < data.length; i++) {
      ...
      FieldProviderFactory.setField(data[i], "CName", agingBalanceData.get(i).getcName());
      FieldProviderFactory.setField(data[i], "USName", agingBalanceData.get(i).getUsName());
    }
  }
