...
import org.openbravo.erpCommon.ad_forms.AcctSchemaElement;
...
public class FactLineSecondary extends FactLine {
  ...
  public FactLineSecondary(String AD_Table_ID, String Record_ID, String Line_ID,
      String Fact_Acct_Group_ID, String SeqNo, String DocBaseType) {
    super(AD_Table_ID, Record_ID, Line_ID, Fact_Acct_Group_ID, SeqNo, DocBaseType);
  ...
  public FactLineSecondary(String AD_Table_ID, String Record_ID, String Line_ID) {
    super(AD_Table_ID, Record_ID, Line_ID);
  }
  ...
  public boolean setAmtSource(String C_Currency_ID, String AmtSourceDr, String AmtSourceCr) {
    super.setAmtSource(C_Currency_ID, AmtSourceDr, AmtSourceCr);
  ...
  public boolean convert(String Acct_Currency_ID, String ConversionDate, String CurrencyRateType,
    ...
    if (m_C_Currency_ID == null || m_C_Currency_ID.equals("-1"))
  ...
  public void setAmtAcct(String AmtAcctDr, String AmtAcctCr) {
    super.setAmtAcct(AmtAcctDr, AmtAcctCr);
  ...
  public void setJournalInfo(String GL_Category_ID) {
    super.setJournalInfo(GL_Category_ID);
  ...
  public void setPostingType(String PostingType) {
    super.setPostingType(PostingType);
  ...
  public void setDocumentInfo(AcctServer docVO, DocLine docLine) {
    super.setDocumentInfo(docVO, docLine);
    m_docVO = docVO;
    m_docLine = docLine;
  } // setDocumentInfo
  ...
  public void setAccount(AcctSchema acctSchema, Account acct) {
    super.setAccount(acctSchema, acct);
  ...
  public void setLocationFromLocator(String M_Locator_ID, boolean isFrom, ConnectionProvider conn) {
    super.setLocationFromLocator(M_Locator_ID, isFrom, conn);
  ...
  public String setC_Period_ID(AcctServer m_docVO, String strDateAcct, ConnectionProvider conn) {
    return super.setC_Period_ID(m_docVO, strDateAcct, conn);
  } // setC_Period_ID
  ...
  public StringBuffer getDescription(ConnectionProvider connectionProvider,
    ...
    return super.getDescription(connectionProvider, strC_Bpartner_ID, strC_AcctSchema_ID,
        strAD_Table_ID, strRecord_ID, strLine);
  }
