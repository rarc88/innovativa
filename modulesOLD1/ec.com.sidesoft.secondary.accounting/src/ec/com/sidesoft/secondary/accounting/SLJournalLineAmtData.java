...
class SLJournalLineAmtData implements FieldProvider {
  ...
  public static SLJournalLineAmtData[] select(ConnectionProvider connectionProvider,
  ...
  public static SLJournalLineAmtData[] select(ConnectionProvider connectionProvider,
    ...
    String strSql = "";
    strSql = strSql + "	SELECT c.C_Currency_ID, c.StdPrecision "
        + "	FROM C_AcctSchema a, C_Currency c " + "	WHERE a.C_Currency_ID=c.C_Currency_ID "
  ...
  public static String selectGeneralLedger(ConnectionProvider connectionProvider, String GLJournalId)
      throws ServletException {
    String strSql = "";
    strSql = strSql + "	select c_acctschema_id from ssacct_journal"
    ...
    try {
      ...
      QueryTimeOutUtil.getInstance().setQueryTimeOut(st, SessionInfo.getQueryProfile());
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, GLJournalId);
