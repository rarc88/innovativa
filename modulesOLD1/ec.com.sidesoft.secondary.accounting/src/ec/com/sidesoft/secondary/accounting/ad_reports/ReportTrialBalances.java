...
public class ReportTrialBalances extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      String strOrg = vars.getGlobalVariable("inpOrg", "ReportTrialBalances|Org", vars.getOrg());
      String strDateFrom = vars
          .getGlobalVariable("inpDateFrom", "ReportTrialBalances|DateFrom", "");
      String strDateTo = vars.getGlobalVariable("inpDateTo", "ReportTrialBalances|DateTo", "");
      String strPageNo = vars.getGlobalVariable("inpPageNo", "ReportTrialBalances|PageNo", "1");
      String strLevel = vars.getGlobalVariable("inpLevel", "ReportTrialBalances|Level", "");
      String strcBpartnerId = vars.getInGlobalVariable("inpcBPartnerId_IN",
          "ReportTrialBalances|cBpartnerId", "", IsIDFilter.instance);
      String strmProductId = vars.getInGlobalVariable("inpmProductId_IN",
          "ReportTrialBalances|mProductId", "", IsIDFilter.instance);
      String strcProjectId = vars.getInGlobalVariable("inpcProjectId_IN",
          "ReportTrialBalances|cProjectId", "", IsIDFilter.instance);
      String strGroupBy = vars.getGlobalVariable("inpGroupBy", "ReportTrialBalances|GroupBy", "");
      String strcElementValueFrom = vars.getGlobalVariable("inpcElementValueIdFrom",
          "ReportTrialBalances|C_ElementValue_IDFROM", "");
      ...
      String strcElementId = trialBalanceDatas[0].elementId;
      String strcElementValueTo = vars.getGlobalVariable(
          ...
          ReportTrialBalanceData.selectLastAccount(readOnlyCP,
              ...
              Utility.getContext(readOnlyCP, vars, "#User_Client", "Account"), strcElementId));
      String strNotInitialBalance = vars.getGlobalVariable("inpNotInitialBalance",
          "ReportTrialBalances|notInitialBalance", "Y");
      String strIncludeZeroFigures = vars.getGlobalVariable("inpIncludeZeroFigures",
          "ReportTrialBalances|includeZeroFigures", "");
      ...
      printPageDataSheet(response, vars, strDateFrom, strDateTo, strPageNo, strOrg, strLevel,
          ...
          strcBpartnerId, strmProductId, strcProjectId, strcElementId, strNotInitialBalance,
          strGroupBy, strIncludeZeroFigures);

    } else if (vars.commandIn("FIND")) {
      String strcElementaId = vars.getRequestGlobalVariable("inpElementId",
          "ReportTrialBalances|inpElementId");
      String strDateFrom = vars.getRequestGlobalVariable("inpDateFrom",
          "ReportTrialBalances|DateFrom");
      String strDateTo = vars.getRequestGlobalVariable("inpDateTo", "ReportTrialBalances|DateTo");
      String strPageNo = vars.getRequestGlobalVariable("inpPageNo", "ReportTrialBalances|PageNo");
      String strOrg = vars.getRequestGlobalVariable("inpOrg", "ReportTrialBalances|Org");
      String strLevel = vars.getRequestGlobalVariable("inpLevel", "ReportTrialBalances|Level");
      ...
      String strGroupBy = vars
          .getRequestGlobalVariable("inpGroupBy", "ReportTrialBalances|GroupBy");
      ...
      String strcElementValueTo = vars.getRequestGlobalVariable("inpcElementValueIdTo",
          "ReportTrialBalances|C_ElementValue_IDTO");
      String strNotInitialBalance = vars.getStringParameter("inpNotInitialBalance", "N");
      vars.setSessionValue("ReportTrialBalances|notInitialBalance", strNotInitialBalance);
      ...
      printPageDataSheet(response, vars, strDateFrom, strDateTo, strPageNo, strOrg, strLevel,
          strcElementValueFrom, strcElementValueTo, strcElementValueFromDes, strcElementValueToDes,
          strcBpartnerId, strmProductId, strcProjectId, strcElementaId, strNotInitialBalance,
          strGroupBy, strIncludeZeroFigures);
      ...
      vars.setSessionValue("ReportTrialBalances|includeZeroFigures", strIncludeZeroFigures);
      ...
      if (vars.commandIn("PDF")) {
        printPageDataPDF(request, response, vars, strDateFrom, strDateTo, strOrg, strLevel,
            ...
            strcElementValueToDes, strcBpartnerId, strmProductId, strcProjectId, strcElementId,
        ...
        printPageDataXLS(request, response, vars, strDateFrom, strDateTo, strOrg, strLevel,
            ...
            strcElementId, strNotInitialBalance, strGroupBy, strIncludeZeroFigures, "");
      }
      ...
      printPageOpen(response, vars, strDateFrom, strDateTo, strOrg, strLevel, strcBpartnerId,
          strmProductId, strcProjectId, strcElementId, strGroupBy, strAccountId,
  ...
  private void printPageOpen(HttpServletResponse response, VariablesSecureApp vars,
      ...
      String strmProductId, String strcProjectId, String strcElementId, String strGroupBy,
  ...
  private void printPageDataSheet(HttpServletResponse response, VariablesSecureApp vars,
    ...
    if (StringUtils.isEmpty(strDateFrom) && StringUtils.isEmpty(strDateTo)) {
      xmlDocument = xmlEngine.readXmlTemplate(
          "ec/com/sidesoft/secondary/accounting/ad_reports/ReportTrialBalances", discard)
          .createXmlDocument();
      data = ReportTrialBalanceData.set();
      ...
      if (StringUtils.equals(strLevel, "S")) { // SubAccount selected
        data = ReportTrialBalanceData.selectLines(readOnlyCP, null, vars.getLanguage(),
            ...
            strOrgFamily,
            Utility.getContext(readOnlyCP, vars, "#User_Client", "ReportTrialBalances"),
            Utility.getContext(readOnlyCP, vars, "#AccessibleOrgTree", "ReportTrialBalances"),
            DateTimeData.nDaysAfter(readOnlyCP, strDateTo, "1"), null, strcBpartnerId,
            strmProductId, strcProjectId, strLevel, " ", strAccountFromValue, strAccountToValue);
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, readOnlyCP, "LIST", "",
          "C_ElementValue level", "", Utility.getContext(readOnlyCP, vars, "#AccessibleOrgTree",
              "ReportTrialBalances"), Utility.getContext(readOnlyCP, vars, "#User_Client",
              "ReportTrialBalances"), 0);
      Utility.fillSQLParameters(readOnlyCP, vars, null, comboTableData, "ReportTrialBalances", "");
    ...
    ToolBar toolbar = new ToolBar(readOnlyCP, vars.getLanguage(), "ReportTrialBalances", false, "",
    ...
    toolbar
        .prepareRelationBarTemplate(
            false,
            false,
            "if (validate()) { submitCommandForm('XLS', false, frmMain, 'ReportTrialBalanceExcels.xls', 'EXCEL'); } return false;");
    xmlDocument.setParameter("toolbar", toolbar.toString());

    try {
      WindowTabs tabs = new WindowTabs(readOnlyCP, vars,
          "ec.com.sidesoft.secondary.accounting.ad_reports.ReportTrialBalances");
      xmlDocument.setParameter("parentTabContainer", tabs.parentTabs());
      xmlDocument.setParameter("mainTabContainer", tabs.mainTabs());
      xmlDocument.setParameter("childTabContainer", tabs.childTabs());
      xmlDocument.setParameter("theme", vars.getTheme());
      NavigationBar nav = new NavigationBar(readOnlyCP, vars.getLanguage(),
          "ReportTrialBalances.html", classInfo.id, classInfo.type, strReplaceWith,
          tabs.breadcrumb());
      xmlDocument.setParameter("navigationBar", nav.toString());
      LeftTabsBar lBar = new LeftTabsBar(readOnlyCP, vars.getLanguage(),
          "ReportTrialBalances.html", strReplaceWith);
      xmlDocument.setParameter("leftTabs", lBar.manualTemplate());
    } catch (Exception ex) {
      throw new ServletException(ex);
    }
    OBError myMessage = vars.getMessage("ReportTrialBalances");
    vars.removeMessage("ReportTrialBalances");
    if (myMessage != null) {
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, readOnlyCP, "TABLEDIR", "AD_ORG_ID",
          ...
          Utility.getContext(readOnlyCP, vars, "#User_Client", "ReportTrialBalances"), '*');
      comboTableData.fillParameters(null, "ReportTrialBalances", "");
  ...
  private void printPageDataXLS(HttpServletRequest request, HttpServletResponse response,
      ...
      String strNotInitialBalance, String strGroupBy, String strIncludeZeroFigures, String elementid)
    ...
    if (StringUtils.isNotEmpty(strDateFrom) && StringUtils.isNotEmpty(strDateTo)
      ...
      if (StringUtils.equals(strLevel, "S")) {
        data = ReportTrialBalanceData.selectXLS(readOnlyCP, vars.getLanguage(), strLevel,
            ...
            strcProjectId, (StringUtils.equals(strNotInitialBalance, "Y") ? "O" : "P"),
            DateTimeData.nDaysAfter(readOnlyCP, strDateTo, "1"));
      ...
      if (data == null || data.length == 0) {
        ...
        Element element = OBDal.getReadOnlyInstance().get(Element.class, strcAcctSchemaId);

        String strReportName = "@basedesign@/ec/com/sidesoft/secondary/accounting/ad_reports/ReportTrialBalanceExcels.jrxml";
  ...
  private void printPageDataPDF(HttpServletRequest request, HttpServletResponse response,
      ...
      String strIncludeZeroFigures, String elementid) throws IOException, ServletException {
    ...
    if (StringUtils.isNotEmpty(strDateFrom) && StringUtils.isNotEmpty(strDateTo)
      ...
      if (data == null || data.length == 0) {
        ...
        String strReportName = "@basedesign@/ec/com/sidesoft/secondary/accounting/ad_reports/ReportTrialBalancePDFs.jrxml";
        HashMap<String, Object> parameters = new HashMap<String, Object>();
