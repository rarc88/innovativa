...
enyo.kind({
            ...
            {kind:"Panels", name:"listPanels", classes:"onyx todos-panels", arrangerKind:"CarouselArranger", components: [
                ...
                {kind:"FittableRows", components: [
                    {kind:"onyx.Toolbar", ondragstart:"noDrag", style: "background-color: #64932D;", layoutKind:"FittableColumnsLayout", components: [
                        ...
                        {name:"newActivityButton",kind:"onyx.Button", content:"New", ontap:"newActPopupCall"},
                    ]},
                    {kind:"Scroller", ondragstart:"noDrag", fit:true, classes:"todos-list", components: [
                    	...
                    	{name:"descrActivityRepeater", kind:"Repeater", onSetupItem: "setActivityDescr", count:"0", components: [
                                 {name: "actDescr", kind: "activityItem", style:"height:230px;",classes: "todos-list-item list-sample-contacts-item enyo-border-box"},
                        ]},
                    ...
                    {name: "newActivityPopup", kind: "onyx.Popup", style:"font-size: 20px;padding: 12px;background: rgba(76, 76, 76, 0.82)",centered: true, floating: true, modal: true, 
                    	components:[
                ...
                {kind:"FittableRows", components: [
                    {kind:"onyx.Toolbar", ondragstart:"noDrag", style: "background-color: #64932D;", layoutKind:"FittableColumnsLayout", components: [
                        {kind: "onyx.InputDecorator", components: [
							{name:"searchInput", kind: "onyx.Input",style: "width:50px", placeholder: "Search", onchange:"inputChanged"},
						...
						{name:"pickerDec",kind: "onyx.PickerDecorator",onSelect: "itemSelected", components: [
							{kind: "onyx.PickerButton", content: "Partner Category", style: "width: 160px"},
    ...
    selectMenuItem: function(inSender, inEvent) {
        ...
        if(this.selectedItemType!='ACTIVITY' & this.selectedItemType != 'OPPORTUNITY')
        	{
			...
			if(this.selectedItemType=='ACTIVITY'){	
				...
				this.$.descrActivityRepeater.show();
				...
				this.$.descrActivityRepeater.hide();
	...
	var item = inEvent.item;
        ...
        if(this.dataDescrTypes != undefined)
        	item.$.actDescr.setDetail(this.dataDescrTypes[i],this.dataDescrNames,this.lStatuses);
    ...
    setFocus: function(inSender, inEvent) {
        ...
        if(this.focus != undefined)
                ...
                //item.$.focusProd.setContent(this.focus[i].value1);       
	return true;
        },    
    ...
    itemSelected:function(inSender, inEvent) {
    	//inSender.setContent(inEvent.originator.content);
    	//this.$.menuDec.setContent(inEvent.originator.content);
...
enyo.kind({
   ...
   getMenuInfoTypes: function(){
    ...
    getTypeDetails: function(bpId,lookupEnum){
    	var detailList;
        var detailNames;
...
enyo.kind({
    ...
    /*
    , alertest: function(inSender, inEvent) {
		alert('cane');
		return true;
	}
	*/
