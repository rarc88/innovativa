...
/**
 * Entity class for entity sshr_type_project (stored in table sshr_type_project).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SshrTypeProject extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sshr_type_project";
    public static final String ENTITY_NAME = "sshr_type_project";
