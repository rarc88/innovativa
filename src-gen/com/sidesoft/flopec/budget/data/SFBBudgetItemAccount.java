...
/**
 * Entity class for entity sfb_budget_item_account (stored in table sfb_budget_item_account).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SFBBudgetItemAccount extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sfb_budget_item_account";
    public static final String ENTITY_NAME = "sfb_budget_item_account";
