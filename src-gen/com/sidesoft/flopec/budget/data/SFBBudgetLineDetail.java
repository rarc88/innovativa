...
/**
 * Entity class for entity sfb_budget_line_detail_v (stored in table sfb_budget_line_detail_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SFBBudgetLineDetail extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sfb_budget_line_detail_v";
    public static final String ENTITY_NAME = "sfb_budget_line_detail_v";
    ...
    public SFBBudgetCertificate getCertificate() {
        return (SFBBudgetCertificate) get(PROPERTY_CERTIFICATE);
    }

    public void setCertificate(SFBBudgetCertificate certificate) {
    ...
    public BigDecimal getReturnorder() {
        return (BigDecimal) get(PROPERTY_RETURNORDER);
    }
