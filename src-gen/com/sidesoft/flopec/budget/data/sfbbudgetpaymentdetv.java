...
/**
 * Entity class for entity sfb_budget_payment_det_v (stored in table sfb_budget_payment_det_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class sfbbudgetpaymentdetv extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sfb_budget_payment_det_v";
    public static final String ENTITY_NAME = "sfb_budget_payment_det_v";
