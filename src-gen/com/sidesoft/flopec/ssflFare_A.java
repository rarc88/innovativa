...
/**
 * Entity class for entity ssfl_fare_a (stored in table ssfl_fare_a).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ssflFare_A extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssfl_fare_a";
    public static final String ENTITY_NAME = "ssfl_fare_a";
