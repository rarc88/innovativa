...
/**
 * Entity class for entity ssfl_fare_b (stored in table ssfl_fare_b).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ssflFare_B extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssfl_fare_b";
    public static final String ENTITY_NAME = "ssfl_fare_b";
