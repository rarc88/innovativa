...
/**
 * Entity class for entity ssfl_ws_contract (stored in table ssfl_ws_contract).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ssflWs_contract extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssfl_ws_contract";
    public static final String ENTITY_NAME = "ssfl_ws_contract";
