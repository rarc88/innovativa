...
/**
 * Entity class for entity SSPR_Calculation_Concepts (stored in table SSPR_Calculation_Concepts).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class CalculationConcepts extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SSPR_Calculation_Concepts";
    public static final String ENTITY_NAME = "SSPR_Calculation_Concepts";
