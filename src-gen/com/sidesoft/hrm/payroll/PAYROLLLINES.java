...
/**
 * Entity class for entity SSPR_prolltem_lines (stored in table sspr_prolltem_lines).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class PAYROLLLINES extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sspr_prolltem_lines";
    public static final String ENTITY_NAME = "SSPR_prolltem_lines";
