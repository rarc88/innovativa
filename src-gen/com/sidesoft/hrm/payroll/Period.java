...
/**
 * Entity class for entity SSPR_Period (stored in table SSPR_Period).
 *
...
public class Period extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String TABLE_NAME = "SSPR_Period";
    public static final String ENTITY_NAME = "SSPR_Period";
    ...
    public org.openbravo.model.financialmgmt.calendar.Period getPeriod() {
        return (org.openbravo.model.financialmgmt.calendar.Period) get(PROPERTY_PERIOD);
    }

    public void setPeriod(org.openbravo.model.financialmgmt.calendar.Period period) {
