...
/**
 * Entity class for entity SSPR_Asientonomina_prov (stored in table SSPR_Asientonomina_prov).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SSPRAsientonomina_prov extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SSPR_Asientonomina_prov";
    public static final String ENTITY_NAME = "SSPR_Asientonomina_prov";
