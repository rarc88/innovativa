...
/**
 * Entity class for entity sfpr_action_type (stored in table sfpr_action_type).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SfprActionType extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sfpr_action_type";
    public static final String ENTITY_NAME = "sfpr_action_type";
