...
/**
 * Entity class for entity sfpr_employee_other (stored in table sfpr_employee_other).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SfprEmployeeOther extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sfpr_employee_other";
    public static final String ENTITY_NAME = "sfpr_employee_other";
