...
/**
 * Entity class for entity sfpr_employee_permit (stored in table sfpr_employee_permit).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SfprEmployeePermit extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sfpr_employee_permit";
    public static final String ENTITY_NAME = "sfpr_employee_permit";
    ...
    public static final String PROPERTY_HOURSNO = "hoursNo";
    public static final String PROPERTY_RECOVERABLE = "recoverable";
    public static final String PROPERTY_EMPLOYEE = "employee";

    public SfprEmployeePermit() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_RECOVERABLE, false);
    }
    ...
    public String getHoursNo() {
        return (String) get(PROPERTY_HOURSNO);
    }

    public void setHoursNo(String hoursNo) {
        set(PROPERTY_HOURSNO, hoursNo);
    }

    public Boolean isRecoverable() {
        return (Boolean) get(PROPERTY_RECOVERABLE);
    }

    public void setRecoverable(Boolean recoverable) {
        set(PROPERTY_RECOVERABLE, recoverable);
    }
