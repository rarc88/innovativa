...
/**
 * Entity class for entity sfpr_job_action (stored in table sfpr_job_action).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SfprJobAction extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sfpr_job_action";
    public static final String ENTITY_NAME = "sfpr_job_action";
