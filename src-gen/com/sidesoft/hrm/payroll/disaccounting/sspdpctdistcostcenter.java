...
/**
 * Entity class for entity sspd_pctdist_costcenter (stored in table sspd_pctdist_costcenter).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class sspdpctdistcostcenter extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sspd_pctdist_costcenter";
    public static final String ENTITY_NAME = "sspd_pctdist_costcenter";
    ...
    public static final String PROPERTY_SSPDPCTDISTEMP = "sspdPctdistEmp";
    ...
    public sspdpctdistemp getSspdPctdistEmp() {
        return (sspdpctdistemp) get(PROPERTY_SSPDPCTDISTEMP);
    }

    public void setSspdPctdistEmp(sspdpctdistemp sspdPctdistEmp) {
        set(PROPERTY_SSPDPCTDISTEMP, sspdPctdistEmp);
    }
