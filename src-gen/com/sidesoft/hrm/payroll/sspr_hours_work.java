...
/**
 * Entity class for entity sspr_hours_work (stored in table sspr_hours_work).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class sspr_hours_work extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sspr_hours_work";
    public static final String ENTITY_NAME = "sspr_hours_work";
    ...
    public static final String PROPERTY_DAYSMONTH = "daysMonth";

    public sspr_hours_work() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_HOURS, (long) 0);
    }
    ...
    public Long getHours() {
        return (Long) get(PROPERTY_HOURS);
    }
    ...
    public String getDaysMonth() {
        return (String) get(PROPERTY_DAYSMONTH);
    }

    public void setDaysMonth(String daysMonth) {
        set(PROPERTY_DAYSMONTH, daysMonth);
    }
