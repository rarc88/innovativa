...
/**
 * Entity class for entity sspr_iessrateline (stored in table sspr_iessrateline).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class sspr_iessrateline extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sspr_iessrateline";
    public static final String ENTITY_NAME = "sspr_iessrateline";
    ...
    public BigDecimal getValueIESSRate() {
        return (BigDecimal) get(PROPERTY_VALUEIESSRATE);
    }

    public void setValueIESSRate(BigDecimal valueIESSRate) {
