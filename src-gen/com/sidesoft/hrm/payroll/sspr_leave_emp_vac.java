...
/**
 * Entity class for entity sspr_leave_emp_vac (stored in table sspr_leave_emp_vac).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class sspr_leave_emp_vac extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sspr_leave_emp_vac";
    public static final String ENTITY_NAME = "sspr_leave_emp_vac";
    ...
    public ssprvacations getVacations() {
        return (ssprvacations) get(PROPERTY_VACATIONS);
    }

    public void setVacations(ssprvacations vacations) {
