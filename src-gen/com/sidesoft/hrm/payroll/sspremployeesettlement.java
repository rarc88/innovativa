...
/**
 * Entity class for entity sspr_employeesettlement (stored in table sspr_employeesettlement).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class sspremployeesettlement extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sspr_employeesettlement";
    public static final String ENTITY_NAME = "sspr_employeesettlement";
    ...
    public static final String PROPERTY_DATEOUT = "dateout";
    public static final String PROPERTY_DESCRIPTION = "description";
    public static final String PROPERTY_PROCESSED = "processed";
    public static final String PROPERTY_GENERATESETTLEMENT = "generatesettlement";
    public static final String PROPERTY_SSPREMPLOYEESETTLEMENTLINELIST = "ssprEmployeesettlementlineList";

    public sspremployeesettlement() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_PROCESSED, false);
        setDefaultValue(PROPERTY_GENERATESETTLEMENT, false);
    ...
    public Date getDateout() {
        return (Date) get(PROPERTY_DATEOUT);
    }

    public void setDateout(Date dateout) {
        set(PROPERTY_DATEOUT, dateout);
    }
    ...
    public Boolean isGeneratesettlement() {
        return (Boolean) get(PROPERTY_GENERATESETTLEMENT);
    }

    public void setGeneratesettlement(Boolean generatesettlement) {
        set(PROPERTY_GENERATESETTLEMENT, generatesettlement);
    }
