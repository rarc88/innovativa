...
/**
 * Entity class for entity sspr_formulary107 (stored in table sspr_formulary107).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ssprformulary107 extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sspr_formulary107";
    public static final String ENTITY_NAME = "sspr_formulary107";
