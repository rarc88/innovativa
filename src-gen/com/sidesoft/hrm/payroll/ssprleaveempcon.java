...
/**
 * Entity class for entity SSPR_relationship (stored in table SSPR_relationship).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ssprleaveempcon extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SSPR_relationship";
    public static final String ENTITY_NAME = "SSPR_relationship";
