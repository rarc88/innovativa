...
/**
 * Entity class for entity sspr_payrollpayment (stored in table sspr_payrollpayment).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ssprpayrollpayment extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sspr_payrollpayment";
    public static final String ENTITY_NAME = "sspr_payrollpayment";
