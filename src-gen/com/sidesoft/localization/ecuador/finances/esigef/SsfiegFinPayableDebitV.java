...
/**
 * Entity class for entity ssfieg_fin_payable_debit_v (stored in table ssfieg_fin_payable_debit_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsfiegFinPayableDebitV extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssfieg_fin_payable_debit_v";
    public static final String ENTITY_NAME = "ssfieg_fin_payable_debit_v";
    ...
    public static final String PROPERTY_TIPOGASTO = "tipoGasto";
    ...
    public String getTipoGasto() {
        return (String) get(PROPERTY_TIPOGASTO);
    }

    public void setTipoGasto(String tipoGasto) {
        set(PROPERTY_TIPOGASTO, tipoGasto);
    }
