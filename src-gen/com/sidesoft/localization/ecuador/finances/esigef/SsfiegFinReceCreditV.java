...
/**
 * Entity class for entity ssfieg_fin_rece_credit_v (stored in table ssfieg_fin_rece_credit_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsfiegFinReceCreditV extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssfieg_fin_rece_credit_v";
    public static final String ENTITY_NAME = "ssfieg_fin_rece_credit_v";
    ...
    public static final String PROPERTY_MONTOHABER = "montoHaber";
    ...
    public BigDecimal getMontoHaber() {
        return (BigDecimal) get(PROPERTY_MONTOHABER);
    }

    public void setMontoHaber(BigDecimal montoHaber) {
        set(PROPERTY_MONTOHABER, montoHaber);
    }
