...
/**
 * Entity class for entity SSWH_Withholding_vendor (stored in table SSWH_Withholding_vendor).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SSWHWithholdingvendor extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SSWH_Withholding_vendor";
    public static final String ENTITY_NAME = "SSWH_Withholding_vendor";
