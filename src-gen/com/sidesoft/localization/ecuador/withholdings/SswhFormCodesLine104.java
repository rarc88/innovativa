...
/**
 * Entity class for entity sswh_form_codesline104 (stored in table sswh_form_codesline104).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SswhFormCodesLine104 extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sswh_form_codesline104";
    public static final String ENTITY_NAME = "sswh_form_codesline104";
    ...
    public static final String PROPERTY_SSWHFORMULARYCODES = "sswhFormularyCodes";
    ...
    public SswhFormularyCodes getSswhFormularyCodes() {
        return (SswhFormularyCodes) get(PROPERTY_SSWHFORMULARYCODES);
    }

    public void setSswhFormularyCodes(SswhFormularyCodes sswhFormularyCodes) {
        set(PROPERTY_SSWHFORMULARYCODES, sswhFormularyCodes);
    }
