...
/**
 * Entity class for entity sswh_formularyline (stored in table sswh_formularyline).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SswhFormularyLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "sswh_formularyline";
    public static final String ENTITY_NAME = "sswh_formularyline";
    ...
    public static final String PROPERTY_SSWHFORMULARY = "sswhFormulary";
    ...
    public SswhFormulary getSswhFormulary() {
        return (SswhFormulary) get(PROPERTY_SSWHFORMULARY);
    }

    public void setSswhFormulary(SswhFormulary sswhFormulary) {
        set(PROPERTY_SSWHFORMULARY, sswhFormulary);
    }
