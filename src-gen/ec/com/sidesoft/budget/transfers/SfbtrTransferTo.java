...
/**
 * Entity class for entity Sfbtr_Transfer_To (stored in table Sfbtr_Transfer_To).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SfbtrTransferTo extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Sfbtr_Transfer_To";
    public static final String ENTITY_NAME = "Sfbtr_Transfer_To";
    ...
    public static final String PROPERTY_BUDGETARYREFORMS = "budgetaryReforms";
    ...
    public SfbtrBudgetaryReforms getBudgetaryReforms() {
        return (SfbtrBudgetaryReforms) get(PROPERTY_BUDGETARYREFORMS);
    }

    public void setBudgetaryReforms(SfbtrBudgetaryReforms budgetaryReforms) {
        set(PROPERTY_BUDGETARYREFORMS, budgetaryReforms);
    }
