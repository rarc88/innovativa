...
/**
 * Entity class for entity ssct_contracttype (stored in table ssct_contracttype).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SsctContractType extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssct_contracttype";
    public static final String ENTITY_NAME = "ssct_contracttype";
    ...
    public static final String PROPERTY_EXTENTION = "extention";
    public static final String PROPERTY_SSCTCONTRACTLIST = "ssctContractList";

    public SsctContractType() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_EXTENTION, true);
    ...
    public Boolean isExtention() {
        return (Boolean) get(PROPERTY_EXTENTION);
    }

    public void setExtention(Boolean extention) {
        set(PROPERTY_EXTENTION, extention);
    }
