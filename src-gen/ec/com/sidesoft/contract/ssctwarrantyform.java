...
/**
 * Entity class for entity ssct_warrantyform (stored in table ssct_warrantyform).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ssctwarrantyform extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssct_warrantyform";
    public static final String ENTITY_NAME = "ssct_warrantyform";
