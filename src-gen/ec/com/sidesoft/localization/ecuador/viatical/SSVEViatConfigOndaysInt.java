...
/**
 * Entity class for entity SSVE_Viat_Config_Ondays_Int (stored in table SSVE_Viat_Config_Ondays_Int).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SSVEViatConfigOndaysInt extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SSVE_Viat_Config_Ondays_Int";
    public static final String ENTITY_NAME = "SSVE_Viat_Config_Ondays_Int";
    ...
    public SSVEViatConfigOndaysInt() {
