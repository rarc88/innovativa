...
/**
 * Entity class for entity SSVE_ViatSettlementLine (stored in table SSVE_ViatSettlementLine).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SSVEViatSettlementLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SSVE_ViatSettlementLine";
    public static final String ENTITY_NAME = "SSVE_ViatSettlementLine";
    ...
    public static final String PROPERTY_TABLEAMT = "tableamt";
    public static final String PROPERTY_MODIFIERS = "modifiers";

    public SSVEViatSettlementLine() {
    ...
    public BigDecimal getTableamt() {
        return (BigDecimal) get(PROPERTY_TABLEAMT);
    }

    public void setTableamt(BigDecimal tableamt) {
        set(PROPERTY_TABLEAMT, tableamt);
    }

    public String getModifiers() {
        return (String) get(PROPERTY_MODIFIERS);
    }

    public void setModifiers(String modifiers) {
        set(PROPERTY_MODIFIERS, modifiers);
    }
