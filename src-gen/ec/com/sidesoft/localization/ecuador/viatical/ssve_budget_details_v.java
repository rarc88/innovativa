...
/**
 * Entity class for entity ssve_budget_details_v (stored in table ssve_budget_details_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ssve_budget_details_v extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssve_budget_details_v";
    public static final String ENTITY_NAME = "ssve_budget_details_v";
    ...
    public static final String PROPERTY_BPARTNERIDVIA = "bpartnerIdVia";
    ...
    public static final String PROPERTY_TOTALAMTCOAL = "totalamtCoal";

    public ssve_budget_details_v() {
    ...
    public BusinessPartner getBpartnerIdVia() {
        return (BusinessPartner) get(PROPERTY_BPARTNERIDVIA);
    }

    public void setBpartnerIdVia(BusinessPartner bpartnerIdVia) {
        set(PROPERTY_BPARTNERIDVIA, bpartnerIdVia);
    }
    ...
    public BigDecimal getTotalamtCoal() {
        return (BigDecimal) get(PROPERTY_TOTALAMTCOAL);
    }

    public void setTotalamtCoal(BigDecimal totalamtCoal) {
        set(PROPERTY_TOTALAMTCOAL, totalamtCoal);
    }
