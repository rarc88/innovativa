...
/**
 * Entity class for entity SSWS_WhSaleDetail_V (stored in table SSWS_WhSaleDetail_V).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SSWSWhSaleDetailV extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SSWS_WhSaleDetail_V";
    public static final String ENTITY_NAME = "SSWS_WhSaleDetail_V";
