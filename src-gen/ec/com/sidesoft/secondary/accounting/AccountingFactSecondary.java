...
/**
 * Entity class for entity SSACCT_AccountingFactSecondary (stored in table ssacct_factacctsecondary).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class AccountingFactSecondary extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ssacct_factacctsecondary";
    public static final String ENTITY_NAME = "SSACCT_AccountingFactSecondary";
    ...
    public static final String PROPERTY_ACTIVITYSECONDARY = "activitySecondary";
    ...
    public AccountingFactSecondary() {
    ...
    public Asset getActivitySecondary() {
        return (Asset) get(PROPERTY_ACTIVITYSECONDARY);
    }

    public void setActivitySecondary(Asset activitySecondary) {
        set(PROPERTY_ACTIVITYSECONDARY, activitySecondary);
    }
