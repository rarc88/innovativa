...
/**
 * Entity class for entity SSACCT_JOURNAL (stored in table SSACCT_JOURNAL).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SSACCTJOURNAL extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SSACCT_JOURNAL";
    public static final String ENTITY_NAME = "SSACCT_JOURNAL";
    ...
    public static final String PROPERTY_BUDGETAREA = "budgetArea";
    public static final String PROPERTY_MULTIGENERALLEDGER = "multigeneralLedger";
    public static final String PROPERTY_ACCOUNTINGSCHEMA = "accountingSchema";
    public static final String PROPERTY_POSTED = "posted";
    public static final String PROPERTY_RBOLDECUENTASSECUNDARIO = "rbolDeCuentasSecundario";
    public static final String PROPERTY_CONTABILIZADO = "contabilizado";
    public static final String PROPERTY_SSACCTJOURNALLINELIST = "sSACCTJournalLineList";

    public SSACCTJOURNAL() {
        ...
        setDefaultValue(PROPERTY_CONTROLAMOUNT, new BigDecimal(0));
        ...
        setDefaultValue(PROPERTY_CONTABILIZADO, false);
    ...
    public SFBBudgetArea getBudgetArea() {
        return (SFBBudgetArea) get(PROPERTY_BUDGETAREA);
    }

    public void setBudgetArea(SFBBudgetArea budgetArea) {
        set(PROPERTY_BUDGETAREA, budgetArea);
    }
    ...
    public Element getRbolDeCuentasSecundario() {
        return (Element) get(PROPERTY_RBOLDECUENTASSECUNDARIO);
    }

    public void setRbolDeCuentasSecundario(Element rbolDeCuentasSecundario) {
        set(PROPERTY_RBOLDECUENTASSECUNDARIO, rbolDeCuentasSecundario);
    }

    public Boolean isContabilizado() {
        return (Boolean) get(PROPERTY_CONTABILIZADO);
    }

    public void setContabilizado(Boolean contabilizado) {
        set(PROPERTY_CONTABILIZADO, contabilizado);
    }
