...
/**
 * Entity class for entity SSACCT_JournalLine (stored in table SSACCT_JournalLine).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class SSACCTJournalLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "SSACCT_JournalLine";
    public static final String ENTITY_NAME = "SSACCT_JournalLine";
    ...
    public static final String PROPERTY_SSACCTJOURNAL = "ssacctJournal";
    ...
    public static final String PROPERTY_AFFECTBUDGET = "affectbudget";
    public static final String PROPERTY_ADDPAYMENT = "addpayment";
    public static final String PROPERTY_GLITEMS = "gLItems";
    public static final String PROPERTY_ISBUDGETED = "isbudgeted";
    public static final String PROPERTY_AFFECTINCOMEBUDGET = "affectincomebudget";

    public SSACCTJournalLine() {
        ...
        setDefaultValue(PROPERTY_RATE, (long) 1);
        ...
        setDefaultValue(PROPERTY_AFFECTBUDGET, false);
        setDefaultValue(PROPERTY_ADDPAYMENT, true);
        setDefaultValue(PROPERTY_ISBUDGETED, false);
        setDefaultValue(PROPERTY_AFFECTINCOMEBUDGET, false);
    }
    ...
    public SSACCTJOURNAL getSsacctJournal() {
        return (SSACCTJOURNAL) get(PROPERTY_SSACCTJOURNAL);
    }

    public void setSsacctJournal(SSACCTJOURNAL ssacctJournal) {
        set(PROPERTY_SSACCTJOURNAL, ssacctJournal);
    }
    ...
    public ElementValue getAccountingCombination() {
        return (ElementValue) get(PROPERTY_ACCOUNTINGCOMBINATION);
    }

    public void setAccountingCombination(ElementValue accountingCombination) {
    ...
    public Product getProject() {
        return (Product) get(PROPERTY_PROJECT);
    }
    ...
    public Boolean isAffectbudget() {
        return (Boolean) get(PROPERTY_AFFECTBUDGET);
    }

    public void setAffectbudget(Boolean affectbudget) {
        set(PROPERTY_AFFECTBUDGET, affectbudget);
    }

    public Boolean isAddpayment() {
        return (Boolean) get(PROPERTY_ADDPAYMENT);
    }

    public void setAddpayment(Boolean addpayment) {
        set(PROPERTY_ADDPAYMENT, addpayment);
    }
    ...
    public Boolean isAffectincomebudget() {
        return (Boolean) get(PROPERTY_AFFECTINCOMEBUDGET);
    }

    public void setAffectincomebudget(Boolean affectincomebudget) {
        set(PROPERTY_AFFECTINCOMEBUDGET, affectincomebudget);
    }
