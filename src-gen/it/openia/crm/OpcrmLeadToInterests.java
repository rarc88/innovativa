...
/**
 * Entity class for entity opcrm_leadtointerests (stored in table opcrm_leadtointerests).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class OpcrmLeadToInterests extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "opcrm_leadtointerests";
    public static final String ENTITY_NAME = "opcrm_leadtointerests";
