...
/**
 * Entity class for entity opcrm_profile_trl (stored in table opcrm_profile_trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class OpcrmProfileTrl extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "opcrm_profile_trl";
    public static final String ENTITY_NAME = "opcrm_profile_trl";
