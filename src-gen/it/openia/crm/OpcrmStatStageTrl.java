...
/**
 * Entity class for entity opcrm_stat_stage_trl (stored in table opcrm_stat_stage_trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class OpcrmStatStageTrl extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "opcrm_stat_stage_trl";
    public static final String ENTITY_NAME = "opcrm_stat_stage_trl";
