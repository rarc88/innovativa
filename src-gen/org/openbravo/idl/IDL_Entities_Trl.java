...
/**
 * Entity class for entity IDL_Entities_Trl (stored in table IDL_Entities_Trl).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class IDL_Entities_Trl extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "IDL_Entities_Trl";
    public static final String ENTITY_NAME = "IDL_Entities_Trl";
    public static final String PROPERTY_ID = "id";
    public static final String PROPERTY_ENTITYREF = "entityRef";
    ...
    public IDL_Entities getEntityRef() {
        return (IDL_Entities) get(PROPERTY_ENTITYREF);
    }

    public void setEntityRef(IDL_Entities entityRef) {
        set(PROPERTY_ENTITYREF, entityRef);
    }
