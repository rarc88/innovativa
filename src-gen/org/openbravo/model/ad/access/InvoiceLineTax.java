...
public class InvoiceLineTax extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSREISCUSTOMERACCOUNTED = "ssreIscustomeraccounted";
    ...
    public InvoiceLineTax() {
        ...
        setDefaultValue(PROPERTY_SSREISCUSTOMERACCOUNTED, false);
    }
    ...
    public Boolean isSsreIscustomeraccounted() {
        return (Boolean) get(PROPERTY_SSREISCUSTOMERACCOUNTED);
    }

    public void setSsreIscustomeraccounted(Boolean ssreIscustomeraccounted) {
        set(PROPERTY_SSREISCUSTOMERACCOUNTED, ssreIscustomeraccounted);
    }
