...
public class ClientInformation extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SIPCISTAXEXPENCE = "sipcIsTaxExpence";
    ...
    public ClientInformation() {
        ...
        setDefaultValue(PROPERTY_SIPCISTAXEXPENCE, false);
    }
    ...
    public Boolean isSipcIsTaxExpence() {
        return (Boolean) get(PROPERTY_SIPCISTAXEXPENCE);
    }

    public void setSipcIsTaxExpence(Boolean sipcIsTaxExpence) {
        set(PROPERTY_SIPCISTAXEXPENCE, sipcIsTaxExpence);
    }
