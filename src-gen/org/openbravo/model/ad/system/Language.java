...
import it.openia.crm.OpcrmEmployNumTrl;
import it.openia.crm.OpcrmFuncinterestTrl;
import it.openia.crm.OpcrmInterestsTrl;
import it.openia.crm.OpcrmLeadPosTrl;
import it.openia.crm.OpcrmLeadSourceTrl;
import it.openia.crm.OpcrmProfileTrl;
import it.openia.crm.OpcrmRejectFactTrl;
import it.openia.crm.OpcrmStatStageTrl;
import it.openia.crm.OpcrmStatusfilterTrl;
import it.openia.crm.OpcrmTitleTrl;
import it.openia.crm.opcrmEvaluationTrl;
...
public class Language extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OPCRMEMPLOYNUMTRLLIST = "opcrmEmployNumTrlList";
    public static final String PROPERTY_OPCRMEVALUATIONTRLLIST = "opcrmEvaluationTrlList";
    public static final String PROPERTY_OPCRMFUNCINTERESTTRLLIST = "opcrmFuncinterestTrlList";
    public static final String PROPERTY_OPCRMINTERESTSTRLLIST = "opcrmInterestsTrlList";
    public static final String PROPERTY_OPCRMLEADPOSTRLLIST = "opcrmLeadPosTrlList";
    public static final String PROPERTY_OPCRMLEADSOURCETRLLIST = "opcrmLeadSourceTrlList";
    public static final String PROPERTY_OPCRMPROFILETRLLIST = "opcrmProfileTrlList";
    public static final String PROPERTY_OPCRMREJECTFACTTRLLIST = "opcrmRejectFactTrlList";
    ...
    public static final String PROPERTY_OPCRMTITLETRLLIST = "opcrmTitleTrlList";
    ...
    public Language() {
        ...
        setDefaultValue(PROPERTY_OPCRMEMPLOYNUMTRLLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OPCRMEVALUATIONTRLLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OPCRMFUNCINTERESTTRLLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OPCRMINTERESTSTRLLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OPCRMLEADPOSTRLLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OPCRMLEADSOURCETRLLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OPCRMPROFILETRLLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OPCRMREJECTFACTTRLLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OPCRMTITLETRLLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<OpcrmEmployNumTrl> getOpcrmEmployNumTrlList() {
      return (List<OpcrmEmployNumTrl>) get(PROPERTY_OPCRMEMPLOYNUMTRLLIST);
    }

    public void setOpcrmEmployNumTrlList(List<OpcrmEmployNumTrl> opcrmEmployNumTrlList) {
        set(PROPERTY_OPCRMEMPLOYNUMTRLLIST, opcrmEmployNumTrlList);
    }

    @SuppressWarnings("unchecked")
    public List<opcrmEvaluationTrl> getOpcrmEvaluationTrlList() {
      return (List<opcrmEvaluationTrl>) get(PROPERTY_OPCRMEVALUATIONTRLLIST);
    }

    public void setOpcrmEvaluationTrlList(List<opcrmEvaluationTrl> opcrmEvaluationTrlList) {
        set(PROPERTY_OPCRMEVALUATIONTRLLIST, opcrmEvaluationTrlList);
    }

    @SuppressWarnings("unchecked")
    public List<OpcrmFuncinterestTrl> getOpcrmFuncinterestTrlList() {
      return (List<OpcrmFuncinterestTrl>) get(PROPERTY_OPCRMFUNCINTERESTTRLLIST);
    }

    public void setOpcrmFuncinterestTrlList(List<OpcrmFuncinterestTrl> opcrmFuncinterestTrlList) {
        set(PROPERTY_OPCRMFUNCINTERESTTRLLIST, opcrmFuncinterestTrlList);
    }

    @SuppressWarnings("unchecked")
    public List<OpcrmInterestsTrl> getOpcrmInterestsTrlList() {
      return (List<OpcrmInterestsTrl>) get(PROPERTY_OPCRMINTERESTSTRLLIST);
    }

    public void setOpcrmInterestsTrlList(List<OpcrmInterestsTrl> opcrmInterestsTrlList) {
        set(PROPERTY_OPCRMINTERESTSTRLLIST, opcrmInterestsTrlList);
    }

    @SuppressWarnings("unchecked")
    public List<OpcrmLeadPosTrl> getOpcrmLeadPosTrlList() {
      return (List<OpcrmLeadPosTrl>) get(PROPERTY_OPCRMLEADPOSTRLLIST);
    }

    public void setOpcrmLeadPosTrlList(List<OpcrmLeadPosTrl> opcrmLeadPosTrlList) {
        set(PROPERTY_OPCRMLEADPOSTRLLIST, opcrmLeadPosTrlList);
    }

    @SuppressWarnings("unchecked")
    public List<OpcrmLeadSourceTrl> getOpcrmLeadSourceTrlList() {
      return (List<OpcrmLeadSourceTrl>) get(PROPERTY_OPCRMLEADSOURCETRLLIST);
    }

    public void setOpcrmLeadSourceTrlList(List<OpcrmLeadSourceTrl> opcrmLeadSourceTrlList) {
        set(PROPERTY_OPCRMLEADSOURCETRLLIST, opcrmLeadSourceTrlList);
    }

    @SuppressWarnings("unchecked")
    public List<OpcrmProfileTrl> getOpcrmProfileTrlList() {
      return (List<OpcrmProfileTrl>) get(PROPERTY_OPCRMPROFILETRLLIST);
    }

    public void setOpcrmProfileTrlList(List<OpcrmProfileTrl> opcrmProfileTrlList) {
        set(PROPERTY_OPCRMPROFILETRLLIST, opcrmProfileTrlList);
    }

    @SuppressWarnings("unchecked")
    public List<OpcrmRejectFactTrl> getOpcrmRejectFactTrlList() {
      return (List<OpcrmRejectFactTrl>) get(PROPERTY_OPCRMREJECTFACTTRLLIST);
    }

    public void setOpcrmRejectFactTrlList(List<OpcrmRejectFactTrl> opcrmRejectFactTrlList) {
        set(PROPERTY_OPCRMREJECTFACTTRLLIST, opcrmRejectFactTrlList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<OpcrmTitleTrl> getOpcrmTitleTrlList() {
      return (List<OpcrmTitleTrl>) get(PROPERTY_OPCRMTITLETRLLIST);
    }

    public void setOpcrmTitleTrlList(List<OpcrmTitleTrl> opcrmTitleTrlList) {
        set(PROPERTY_OPCRMTITLETRLLIST, opcrmTitleTrlList);
    }
