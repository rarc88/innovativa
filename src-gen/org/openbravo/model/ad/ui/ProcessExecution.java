...
public class ProcessExecution extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PROCESSEXECUTIONTRIGGEREDBYGROUPEXECUTIONLIST = "processExecutionTriggeredByGroupExecutionList";
    public static final String PROPERTY_PROCESSRUNTRIGGEREDBYGROUPEXECUTIONLIST = "processRunTriggeredByGroupExecutionList";
    ...
    public ProcessExecution() {
        ...
        setDefaultValue(PROPERTY_PROCESSEXECUTIONTRIGGEREDBYGROUPEXECUTIONLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROCESSRUNTRIGGEREDBYGROUPEXECUTIONLIST, new ArrayList<Object>());
    }
    ...
    public List<ProcessExecution> getProcessExecutionTriggeredByGroupExecutionList() {
      return (List<ProcessExecution>) get(PROPERTY_PROCESSEXECUTIONTRIGGEREDBYGROUPEXECUTIONLIST);
    }

    public void setProcessExecutionTriggeredByGroupExecutionList(List<ProcessExecution> processExecutionTriggeredByGroupExecutionList) {
        set(PROPERTY_PROCESSEXECUTIONTRIGGEREDBYGROUPEXECUTIONLIST, processExecutionTriggeredByGroupExecutionList);
    }

    @SuppressWarnings("unchecked")
    public List<ProcessRun> getProcessRunTriggeredByGroupExecutionList() {
      return (List<ProcessRun>) get(PROPERTY_PROCESSRUNTRIGGEREDBYGROUPEXECUTIONLIST);
    }

    public void setProcessRunTriggeredByGroupExecutionList(List<ProcessRun> processRunTriggeredByGroupExecutionList) {
        set(PROPERTY_PROCESSRUNTRIGGEREDBYGROUPEXECUTIONLIST, processRunTriggeredByGroupExecutionList);
    }
