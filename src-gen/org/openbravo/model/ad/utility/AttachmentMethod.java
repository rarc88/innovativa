...
public class AttachmentMethod extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ATTACHMENTCONFIGLIST = "attachmentConfigList";
    public static final String PROPERTY_OBUIAPPPARAMETERLIST = "oBUIAPPParameterList";

    public AttachmentMethod() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_ATTACHMENTCONFIGLIST, new ArrayList<Object>());
    ...
    public List<AttachmentConfig> getAttachmentConfigList() {
      return (List<AttachmentConfig>) get(PROPERTY_ATTACHMENTCONFIGLIST);
    }

    public void setAttachmentConfigList(List<AttachmentConfig> attachmentConfigList) {
        set(PROPERTY_ATTACHMENTCONFIGLIST, attachmentConfigList);
    }
