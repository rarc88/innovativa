...
public class Bank extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSWHBANKPV = "sswhBankpv";
    ...
    public Bank() {
        ...
        setDefaultValue(PROPERTY_SSWHBANKPV, false);
    ...
    public Boolean isSswhBankpv() {
        return (Boolean) get(PROPERTY_SSWHBANKPV);
    }

    public void setSswhBankpv(Boolean sswhBankpv) {
        set(PROPERTY_SSWHBANKPV, sswhBankpv);
    }
