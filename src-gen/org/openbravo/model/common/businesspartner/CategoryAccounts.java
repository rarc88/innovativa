...
public class CategoryAccounts extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSPYRECEIPTPRVYEARACCT = "sspyReceiptPrvyearAcct";
    public static final String PROPERTY_SSPYPREPAIDPRVYEARACCT = "sspyPrepaidPrvyearAcct";
    ...
    public AccountingCombination getSspyReceiptPrvyearAcct() {
        return (AccountingCombination) get(PROPERTY_SSPYRECEIPTPRVYEARACCT);
    }

    public void setSspyReceiptPrvyearAcct(AccountingCombination sspyReceiptPrvyearAcct) {
        set(PROPERTY_SSPYRECEIPTPRVYEARACCT, sspyReceiptPrvyearAcct);
    }

    public AccountingCombination getSspyPrepaidPrvyearAcct() {
        return (AccountingCombination) get(PROPERTY_SSPYPREPAIDPRVYEARACCT);
    }

    public void setSspyPrepaidPrvyearAcct(AccountingCombination sspyPrepaidPrvyearAcct) {
        set(PROPERTY_SSPYPREPAIDPRVYEARACCT, sspyPrepaidPrvyearAcct);
    }
