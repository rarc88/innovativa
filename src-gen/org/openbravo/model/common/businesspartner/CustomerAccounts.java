...
public class CustomerAccounts extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SCNACNCPROVEEDOR = "scnacNcproveedor";
    ...
    public AccountingCombination getScnacNcproveedor() {
        return (AccountingCombination) get(PROPERTY_SCNACNCPROVEEDOR);
    }

    public void setScnacNcproveedor(AccountingCombination scnacNcproveedor) {
        set(PROPERTY_SCNACNCPROVEEDOR, scnacNcproveedor);
    }
