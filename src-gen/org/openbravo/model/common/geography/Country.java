...
import com.sidesoft.flopec.Port;
...
import ec.com.sidesoft.localization.ecuador.viatical.SSVECountryRate;
...
public class Country extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_COSTCENTEREMSSFLCCOUNTRYIDLIST = "costcenterEMSsflCCountryIDList";
    ...
    public static final String PROPERTY_SSFLPORTLIST = "sSFLPortList";
    public static final String PROPERTY_SSVECOUNTRYRATELIST = "sSVECountryRateList";
    ...
    public Country() {
        ...
        setDefaultValue(PROPERTY_COSTCENTEREMSSFLCCOUNTRYIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SSFLPORTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSVECOUNTRYRATELIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<Costcenter> getCostcenterEMSsflCCountryIDList() {
      return (List<Costcenter>) get(PROPERTY_COSTCENTEREMSSFLCCOUNTRYIDLIST);
    }

    public void setCostcenterEMSsflCCountryIDList(List<Costcenter> costcenterEMSsflCCountryIDList) {
        set(PROPERTY_COSTCENTEREMSSFLCCOUNTRYIDLIST, costcenterEMSsflCCountryIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Port> getSSFLPortList() {
      return (List<Port>) get(PROPERTY_SSFLPORTLIST);
    }

    public void setSSFLPortList(List<Port> sSFLPortList) {
        set(PROPERTY_SSFLPORTLIST, sSFLPortList);
    }

    @SuppressWarnings("unchecked")
    public List<SSVECountryRate> getSSVECountryRateList() {
      return (List<SSVECountryRate>) get(PROPERTY_SSVECOUNTRYRATELIST);
    }

    public void setSSVECountryRateList(List<SSVECountryRate> sSVECountryRateList) {
        set(PROPERTY_SSVECOUNTRYRATELIST, sSVECountryRateList);
    }
