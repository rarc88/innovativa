...
public class OrderLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SFBEXECUTEDVALUE = "sfbExecutedvalue";
    ...
    public OrderLine() {
        ...
        setDefaultValue(PROPERTY_SFBEXECUTEDVALUE, new BigDecimal(0));
    ...
    public BigDecimal getSfbExecutedvalue() {
        return (BigDecimal) get(PROPERTY_SFBEXECUTEDVALUE);
    }

    public void setSfbExecutedvalue(BigDecimal sfbExecutedvalue) {
        set(PROPERTY_SFBEXECUTEDVALUE, sfbExecutedvalue);
    }
