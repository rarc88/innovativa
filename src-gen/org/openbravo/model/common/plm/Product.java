...
public class Product extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSACCTJOURNALLINEPROJECTLIST = "sSACCTJournalLineProjectList";
    ...
    public Product() {
        ...
        setDefaultValue(PROPERTY_SSACCTJOURNALLINEPROJECTLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<SSACCTJournalLine> getSSACCTJournalLineProjectList() {
      return (List<SSACCTJournalLine>) get(PROPERTY_SSACCTJOURNALLINEPROJECTLIST);
    }

    public void setSSACCTJournalLineProjectList(List<SSACCTJournalLine> sSACCTJournalLineProjectList) {
        set(PROPERTY_SSACCTJOURNALLINEPROJECTLIST, sSACCTJournalLineProjectList);
    }
