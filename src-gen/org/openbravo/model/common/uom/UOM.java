...
public class UOM extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ECSPPPACLIST = "ecsppPacList";
    ...
    public UOM() {
        ...
        setDefaultValue(PROPERTY_ECSPPPACLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<EcsppPAC> getEcsppPacList() {
      return (List<EcsppPAC>) get(PROPERTY_ECSPPPACLIST);
    }

    public void setEcsppPacList(List<EcsppPAC> ecsppPacList) {
        set(PROPERTY_ECSPPPACLIST, ecsppPacList);
    }
