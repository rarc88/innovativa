...
/**
 * Entity class for entity FinancialMgmtAccountingFactEndYear (stored in table Fact_Acct_End_Year_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class AccountingFactEndYear extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Fact_Acct_End_Year_v";
    public static final String ENTITY_NAME = "FinancialMgmtAccountingFactEndYear";
    ...
    public static final String PROPERTY_YEARCLOSEV = "yearCloseV";
    ...
    public YearClose getYearCloseV() {
        return (YearClose) get(PROPERTY_YEARCLOSEV);
    }

    public void setYearCloseV(YearClose yearCloseV) {
        set(PROPERTY_YEARCLOSEV, yearCloseV);
    }
