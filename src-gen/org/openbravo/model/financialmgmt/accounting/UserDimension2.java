...
import com.sidesoft.flopec.ssflUser2line;
...
public class UserDimension2 extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSFLUSER1 = "ssflUser1";
    public static final String PROPERTY_SSFLCCOSTCENTER = "ssflCCostcenter";
    public static final String PROPERTY_SSFLSTARTDATE = "ssflStartdate";
    public static final String PROPERTY_SSFLENDDATE = "ssflEnddate";
    public static final String PROPERTY_SSFLVALUERECAP1 = "ssflValuerecap1";
    public static final String PROPERTY_SSFLVALUERECAP2 = "ssflValuerecap2";
    public static final String PROPERTY_SSFLVALUERECAP3 = "ssflValuerecap3";
    public static final String PROPERTY_SSFLCUSTOMERVOYAGENO = "ssflCustomerVoyageNo";
    public static final String PROPERTY_SSFLBROKERVALUE = "ssflBrokervalue";
    public static final String PROPERTY_SSFLTYPERECAP = "ssflTypeRecap";
    public static final String PROPERTY_SSFLNAME = "ssflName";
    public static final String PROPERTY_SSFLBROKERVALUE2 = "ssflBrokervalue2";
    ...
    public static final String PROPERTY_FINPAYMENTDETAILEMSFBUSER2IDLIST = "fINPaymentDetailEMSfbUser2IDList";
    ...
    public static final String PROPERTY_SSFLUSER2LINELIST = "ssflUser2lineList";

    public UserDimension2() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_SUMMARYLEVEL, false);
        setDefaultValue(PROPERTY_SSFLTYPERECAP, "1");
        ...
        setDefaultValue(PROPERTY_FINPAYMENTDETAILEMSFBUSER2IDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_SSFLUSER2LINELIST, new ArrayList<Object>());
    }
    ...
    public UserDimension1 getSsflUser1() {
        return (UserDimension1) get(PROPERTY_SSFLUSER1);
    }

    public void setSsflUser1(UserDimension1 ssflUser1) {
        set(PROPERTY_SSFLUSER1, ssflUser1);
    }

    public Costcenter getSsflCCostcenter() {
        return (Costcenter) get(PROPERTY_SSFLCCOSTCENTER);
    }

    public void setSsflCCostcenter(Costcenter ssflCCostcenter) {
        set(PROPERTY_SSFLCCOSTCENTER, ssflCCostcenter);
    }

    public Date getSsflStartdate() {
        return (Date) get(PROPERTY_SSFLSTARTDATE);
    }

    public void setSsflStartdate(Date ssflStartdate) {
        set(PROPERTY_SSFLSTARTDATE, ssflStartdate);
    }
    ...
    public ssflRecap getSsflValuerecap1() {
        return (ssflRecap) get(PROPERTY_SSFLVALUERECAP1);
    }

    public void setSsflValuerecap1(ssflRecap ssflValuerecap1) {
        set(PROPERTY_SSFLVALUERECAP1, ssflValuerecap1);
    }

    public ssflRecap getSsflValuerecap2() {
        return (ssflRecap) get(PROPERTY_SSFLVALUERECAP2);
    }

    public void setSsflValuerecap2(ssflRecap ssflValuerecap2) {
        set(PROPERTY_SSFLVALUERECAP2, ssflValuerecap2);
    }

    public ssflRecap getSsflValuerecap3() {
        return (ssflRecap) get(PROPERTY_SSFLVALUERECAP3);
    }

    public void setSsflValuerecap3(ssflRecap ssflValuerecap3) {
        set(PROPERTY_SSFLVALUERECAP3, ssflValuerecap3);
    }

    public String getSsflCustomerVoyageNo() {
        return (String) get(PROPERTY_SSFLCUSTOMERVOYAGENO);
    }

    public void setSsflCustomerVoyageNo(String ssflCustomerVoyageNo) {
        set(PROPERTY_SSFLCUSTOMERVOYAGENO, ssflCustomerVoyageNo);
    }

    public BusinessPartner getSsflBrokervalue() {
        return (BusinessPartner) get(PROPERTY_SSFLBROKERVALUE);
    }

    public void setSsflBrokervalue(BusinessPartner ssflBrokervalue) {
        set(PROPERTY_SSFLBROKERVALUE, ssflBrokervalue);
    }
    ...
    public String getSsflName() {
        return (String) get(PROPERTY_SSFLNAME);
    }

    public void setSsflName(String ssflName) {
        set(PROPERTY_SSFLNAME, ssflName);
    }

    public BusinessPartner getSsflBrokervalue2() {
        return (BusinessPartner) get(PROPERTY_SSFLBROKERVALUE2);
    }

    public void setSsflBrokervalue2(BusinessPartner ssflBrokervalue2) {
        set(PROPERTY_SSFLBROKERVALUE2, ssflBrokervalue2);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<FIN_PaymentDetail> getFINPaymentDetailEMSfbUser2IDList() {
      return (List<FIN_PaymentDetail>) get(PROPERTY_FINPAYMENTDETAILEMSFBUSER2IDLIST);
    }

    public void setFINPaymentDetailEMSfbUser2IDList(List<FIN_PaymentDetail> fINPaymentDetailEMSfbUser2IDList) {
        set(PROPERTY_FINPAYMENTDETAILEMSFBUSER2IDLIST, fINPaymentDetailEMSfbUser2IDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ssflUser2line> getSsflUser2lineList() {
      return (List<ssflUser2line>) get(PROPERTY_SSFLUSER2LINELIST);
    }

    public void setSsflUser2lineList(List<ssflUser2line> ssflUser2lineList) {
        set(PROPERTY_SSFLUSER2LINELIST, ssflUser2lineList);
    }
