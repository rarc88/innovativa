...
public class Element extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSACCTJOURNALRBOLDECUENTASSECUNDARIOLIST = "sSACCTJOURNALrbolDeCuentasSecundarioList";
    public static final String PROPERTY_SSACCTMATCHACCOUNTSELEMENTIDLIST = "ssacctMatchAccountsElementIDList";
    ...
    public Element() {
        ...
        setDefaultValue(PROPERTY_SSACCTJOURNALRBOLDECUENTASSECUNDARIOLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSACCTMATCHACCOUNTSELEMENTIDLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SSACCTJOURNAL> getSSACCTJOURNALrbolDeCuentasSecundarioList() {
      return (List<SSACCTJOURNAL>) get(PROPERTY_SSACCTJOURNALRBOLDECUENTASSECUNDARIOLIST);
    }

    public void setSSACCTJOURNALrbolDeCuentasSecundarioList(List<SSACCTJOURNAL> sSACCTJOURNALrbolDeCuentasSecundarioList) {
        set(PROPERTY_SSACCTJOURNALRBOLDECUENTASSECUNDARIOLIST, sSACCTJOURNALrbolDeCuentasSecundarioList);
    }

    @SuppressWarnings("unchecked")
    public List<Ssacct_MatchAccounts> getSsacctMatchAccountsElementIDList() {
      return (List<Ssacct_MatchAccounts>) get(PROPERTY_SSACCTMATCHACCOUNTSELEMENTIDLIST);
    }

    public void setSsacctMatchAccountsElementIDList(List<Ssacct_MatchAccounts> ssacctMatchAccountsElementIDList) {
        set(PROPERTY_SSACCTMATCHACCOUNTSELEMENTIDLIST, ssacctMatchAccountsElementIDList);
    }
