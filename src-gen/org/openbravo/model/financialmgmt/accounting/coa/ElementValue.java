...
import com.sidesoft.flopec.budget.data.SFBBudgetItemAccount;
...
public class ElementValue extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSACCTACCOUNTINGFACTSECONDARYACCOUNTLIST = "sSACCTAccountingFactSecondaryAccountList";
    public static final String PROPERTY_SSACCTJOURNALLINEACCOUNTINGCOMBINATIONLIST = "sSACCTJournalLineAccountingCombinationList";
    public static final String PROPERTY_SFBBUDGETITEMACCOUNTACCOUNTLIST = "sfbBudgetItemAccountAccountList";
    public static final String PROPERTY_SSACCTMATCHACCOUNTSACCOUNTIDMAINLIST = "ssacctMatchAccountsAccountIdMainList";
    public static final String PROPERTY_SSACCTMATCHACCOUNTSACCOUNTIDDEPENDENTLIST = "ssacctMatchAccountsAccountIdDependentList";
    ...
    public ElementValue() {
        ...
        setDefaultValue(PROPERTY_SSACCTACCOUNTINGFACTSECONDARYACCOUNTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSACCTJOURNALLINEACCOUNTINGCOMBINATIONLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SFBBUDGETITEMACCOUNTACCOUNTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSACCTMATCHACCOUNTSACCOUNTIDMAINLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SSACCTMATCHACCOUNTSACCOUNTIDDEPENDENTLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<AccountingFactSecondary> getSSACCTAccountingFactSecondaryAccountList() {
      return (List<AccountingFactSecondary>) get(PROPERTY_SSACCTACCOUNTINGFACTSECONDARYACCOUNTLIST);
    }

    public void setSSACCTAccountingFactSecondaryAccountList(List<AccountingFactSecondary> sSACCTAccountingFactSecondaryAccountList) {
        set(PROPERTY_SSACCTACCOUNTINGFACTSECONDARYACCOUNTLIST, sSACCTAccountingFactSecondaryAccountList);
    }

    @SuppressWarnings("unchecked")
    public List<SSACCTJournalLine> getSSACCTJournalLineAccountingCombinationList() {
      return (List<SSACCTJournalLine>) get(PROPERTY_SSACCTJOURNALLINEACCOUNTINGCOMBINATIONLIST);
    }

    public void setSSACCTJournalLineAccountingCombinationList(List<SSACCTJournalLine> sSACCTJournalLineAccountingCombinationList) {
        set(PROPERTY_SSACCTJOURNALLINEACCOUNTINGCOMBINATIONLIST, sSACCTJournalLineAccountingCombinationList);
    }

    @SuppressWarnings("unchecked")
    public List<SFBBudgetItemAccount> getSfbBudgetItemAccountAccountList() {
      return (List<SFBBudgetItemAccount>) get(PROPERTY_SFBBUDGETITEMACCOUNTACCOUNTLIST);
    }

    public void setSfbBudgetItemAccountAccountList(List<SFBBudgetItemAccount> sfbBudgetItemAccountAccountList) {
        set(PROPERTY_SFBBUDGETITEMACCOUNTACCOUNTLIST, sfbBudgetItemAccountAccountList);
    }

    @SuppressWarnings("unchecked")
    public List<Ssacct_MatchAccounts> getSsacctMatchAccountsAccountIdMainList() {
      return (List<Ssacct_MatchAccounts>) get(PROPERTY_SSACCTMATCHACCOUNTSACCOUNTIDMAINLIST);
    }

    public void setSsacctMatchAccountsAccountIdMainList(List<Ssacct_MatchAccounts> ssacctMatchAccountsAccountIdMainList) {
        set(PROPERTY_SSACCTMATCHACCOUNTSACCOUNTIDMAINLIST, ssacctMatchAccountsAccountIdMainList);
    }

    @SuppressWarnings("unchecked")
    public List<Ssacct_MatchAccounts> getSsacctMatchAccountsAccountIdDependentList() {
      return (List<Ssacct_MatchAccounts>) get(PROPERTY_SSACCTMATCHACCOUNTSACCOUNTIDDEPENDENTLIST);
    }

    public void setSsacctMatchAccountsAccountIdDependentList(List<Ssacct_MatchAccounts> ssacctMatchAccountsAccountIdDependentList) {
        set(PROPERTY_SSACCTMATCHACCOUNTSACCOUNTIDDEPENDENTLIST, ssacctMatchAccountsAccountIdDependentList);
    }
