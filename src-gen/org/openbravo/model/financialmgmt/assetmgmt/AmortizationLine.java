...
public class AmortizationLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSAMAASSETGROUP = "ssamAAssetGroup";
    ...
    public AssetGroup getSsamAAssetGroup() {
        return (AssetGroup) get(PROPERTY_SSAMAASSETGROUP);
    }

    public void setSsamAAssetGroup(AssetGroup ssamAAssetGroup) {
        set(PROPERTY_SSAMAASSETGROUP, ssamAAssetGroup);
    }
