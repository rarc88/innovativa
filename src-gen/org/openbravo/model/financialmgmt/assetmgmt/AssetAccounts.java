...
public class AssetAccounts extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSAMSALESACCT = "ssamSalesAcct";
    public static final String PROPERTY_SSAMHISTORICCOSTACCT = "ssamHistoriccostAcct";
    public static final String PROPERTY_SSAMRESULTALIENATEACCT = "ssamResultalienateAcct";
    ...
    public AccountingCombination getSsamSalesAcct() {
        return (AccountingCombination) get(PROPERTY_SSAMSALESACCT);
    }

    public void setSsamSalesAcct(AccountingCombination ssamSalesAcct) {
        set(PROPERTY_SSAMSALESACCT, ssamSalesAcct);
    }

    public AccountingCombination getSsamHistoriccostAcct() {
        return (AccountingCombination) get(PROPERTY_SSAMHISTORICCOSTACCT);
    }

    public void setSsamHistoriccostAcct(AccountingCombination ssamHistoriccostAcct) {
        set(PROPERTY_SSAMHISTORICCOSTACCT, ssamHistoriccostAcct);
    }

    public AccountingCombination getSsamResultalienateAcct() {
        return (AccountingCombination) get(PROPERTY_SSAMRESULTALIENATEACCT);
    }

    public void setSsamResultalienateAcct(AccountingCombination ssamResultalienateAcct) {
        set(PROPERTY_SSAMRESULTALIENATEACCT, ssamResultalienateAcct);
    }
