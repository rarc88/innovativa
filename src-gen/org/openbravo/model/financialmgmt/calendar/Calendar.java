...
public class Calendar extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ORGANIZATIONINHERITEDCALENDARLIST = "organizationInheritedCalendarList";
    ...
    public Calendar() {
        ...
        setDefaultValue(PROPERTY_ORGANIZATIONINHERITEDCALENDARLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<Organization> getOrganizationInheritedCalendarList() {
      return (List<Organization>) get(PROPERTY_ORGANIZATIONINHERITEDCALENDARLIST);
    }

    public void setOrganizationInheritedCalendarList(List<Organization> organizationInheritedCalendarList) {
        set(PROPERTY_ORGANIZATIONINHERITEDCALENDARLIST, organizationInheritedCalendarList);
    }
