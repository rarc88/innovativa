...
import com.sidesoft.localization.ecuador.withholdings.SSWHCheckbookline;
...
public class BankStatementLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SSWHPARTNER = "sswhPartner";
    public static final String PROPERTY_SSWHPRINT = "sswhPrint";
    ...
    public BankStatementLine() {
        ...
        setDefaultValue(PROPERTY_SSWHPRINT, false);
    ...
    public BusinessPartner getSswhPartner() {
        return (BusinessPartner) get(PROPERTY_SSWHPARTNER);
    }

    public void setSswhPartner(BusinessPartner sswhPartner) {
        set(PROPERTY_SSWHPARTNER, sswhPartner);
    }

    public Boolean isSswhPrint() {
        return (Boolean) get(PROPERTY_SSWHPRINT);
    }

    public void setSswhPrint(Boolean sswhPrint) {
        set(PROPERTY_SSWHPRINT, sswhPrint);
    }
