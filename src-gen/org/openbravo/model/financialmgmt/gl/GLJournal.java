...
public class GLJournal extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SFBAREA = "sFBArea";
    ...
    public SFBBudgetArea getSFBArea() {
        return (SFBBudgetArea) get(PROPERTY_SFBAREA);
    }

    public void setSFBArea(SFBBudgetArea sFBArea) {
        set(PROPERTY_SFBAREA, sFBArea);
    }
