...
import com.sidesoft.flopec.budget.data.SFBBudgetJournalLineLog;
...
public class GLJournalLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SFBAFFECTBUDGET = "sfbAffectbudget";
    public static final String PROPERTY_SFBINAFFECTINCOMEBUDGET = "sfbinAffectIncomeBudget";
    public static final String PROPERTY_SFBBUDGETED = "sFBBudgeted";
    public static final String PROPERTY_SFBBUDGETJOURNALLINELOGLIST = "sFBBudgetJournalLineLogList";
    ...
    public GLJournalLine() {
        ...
        setDefaultValue(PROPERTY_SFBAFFECTBUDGET, false);
        setDefaultValue(PROPERTY_SFBINAFFECTINCOMEBUDGET, false);
        setDefaultValue(PROPERTY_SFBBUDGETED, false);
        setDefaultValue(PROPERTY_SFBBUDGETJOURNALLINELOGLIST, new ArrayList<Object>());
    ...
    public Boolean isSfbAffectbudget() {
        return (Boolean) get(PROPERTY_SFBAFFECTBUDGET);
    }

    public void setSfbAffectbudget(Boolean sfbAffectbudget) {
        set(PROPERTY_SFBAFFECTBUDGET, sfbAffectbudget);
    }

    public Boolean isSfbinAffectIncomeBudget() {
        return (Boolean) get(PROPERTY_SFBINAFFECTINCOMEBUDGET);
    }

    public void setSfbinAffectIncomeBudget(Boolean sfbinAffectIncomeBudget) {
        set(PROPERTY_SFBINAFFECTINCOMEBUDGET, sfbinAffectIncomeBudget);
    }
    ...
    public List<SFBBudgetJournalLineLog> getSFBBudgetJournalLineLogList() {
      return (List<SFBBudgetJournalLineLog>) get(PROPERTY_SFBBUDGETJOURNALLINELOGLIST);
    }

    public void setSFBBudgetJournalLineLogList(List<SFBBudgetJournalLineLog> sFBBudgetJournalLineLogList) {
        set(PROPERTY_SFBBUDGETJOURNALLINELOGLIST, sFBBudgetJournalLineLogList);
    }
