...
public class FIN_Payment extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SFBPROCESS = "sfbProcess";
    public static final String PROPERTY_SSVEVIATICAL = "ssveViatical";
    public static final String PROPERTY_SFBHASHCODE = "sFBHashCode";
    public static final String PROPERTY_SSVEVIATSETTLEMENT = "ssveViatSettlement";
    ...
    public static final String PROPERTY_SSFIISBANKTRANSFER = "ssfiIsbanktransfer";
    public static final String PROPERTY_SSVEVIATICALAMOUNT = "ssveViaticalamount";
    ...
    public FIN_Payment() {
        ...
        setDefaultValue(PROPERTY_SFBPROCESS, "N");
        setDefaultValue(PROPERTY_SFBBUDGETED, false);
        setDefaultValue(PROPERTY_SSIORDETAILREPORT, false);
        setDefaultValue(PROPERTY_SSFIISBANKTRANSFER, false);
        setDefaultValue(PROPERTY_SSVEVIATICALAMOUNT, new BigDecimal(0));
    ...
    public String getSfbProcess() {
        return (String) get(PROPERTY_SFBPROCESS);
    }

    public void setSfbProcess(String sfbProcess) {
        set(PROPERTY_SFBPROCESS, sfbProcess);
    }
    ...
    public SSVEViaticalSettlement getSsveViatSettlement() {
        return (SSVEViaticalSettlement) get(PROPERTY_SSVEVIATSETTLEMENT);
    }

    public void setSsveViatSettlement(SSVEViaticalSettlement ssveViatSettlement) {
        set(PROPERTY_SSVEVIATSETTLEMENT, ssveViatSettlement);
    }
    ...
    public Boolean isSsfiIsbanktransfer() {
        return (Boolean) get(PROPERTY_SSFIISBANKTRANSFER);
    }

    public void setSsfiIsbanktransfer(Boolean ssfiIsbanktransfer) {
        set(PROPERTY_SSFIISBANKTRANSFER, ssfiIsbanktransfer);
    }

    public BigDecimal getSsveViaticalamount() {
        return (BigDecimal) get(PROPERTY_SSVEVIATICALAMOUNT);
    }

    public void setSsveViaticalamount(BigDecimal ssveViaticalamount) {
        set(PROPERTY_SSVEVIATICALAMOUNT, ssveViaticalamount);
    }
