...
public class FIN_PaymentProposal extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SLPPPAYMENTDOCTYPE = "slppPaymentDoctype";
    ...
    public DocumentType getSlppPaymentDoctype() {
        return (DocumentType) get(PROPERTY_SLPPPAYMENTDOCTYPE);
    }

    public void setSlppPaymentDoctype(DocumentType slppPaymentDoctype) {
        set(PROPERTY_SLPPPAYMENTDOCTYPE, slppPaymentDoctype);
    }
