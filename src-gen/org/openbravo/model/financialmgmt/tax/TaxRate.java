...
public class TaxRate extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_SWSICCONFIGTAXIVALIST = "sWSICConfigTAXIvaList";
    public static final String PROPERTY_SWSICCONFIGTAXSERVICELIST = "sWSICConfigTAXServiceList";
    ...
    public TaxRate() {
        ...
        setDefaultValue(PROPERTY_SWSICCONFIGTAXIVALIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_SWSICCONFIGTAXSERVICELIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<SWSICConfig> getSWSICConfigTAXIvaList() {
      return (List<SWSICConfig>) get(PROPERTY_SWSICCONFIGTAXIVALIST);
    }

    public void setSWSICConfigTAXIvaList(List<SWSICConfig> sWSICConfigTAXIvaList) {
        set(PROPERTY_SWSICCONFIGTAXIVALIST, sWSICConfigTAXIvaList);
    }

    @SuppressWarnings("unchecked")
    public List<SWSICConfig> getSWSICConfigTAXServiceList() {
      return (List<SWSICConfig>) get(PROPERTY_SWSICCONFIGTAXSERVICELIST);
    }

    public void setSWSICConfigTAXServiceList(List<SWSICConfig> sWSICConfigTAXServiceList) {
        set(PROPERTY_SWSICCONFIGTAXSERVICELIST, sWSICConfigTAXServiceList);
    }
