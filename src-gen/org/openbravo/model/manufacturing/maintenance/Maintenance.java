...
public class Maintenance extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_MANUFACTURINGMAINTENANCEPERIODICITYLIST = "manufacturingMaintenancePeriodicityList";
    ...
    public Maintenance() {
        ...
        setDefaultValue(PROPERTY_MANUFACTURINGMAINTENANCEPERIODICITYLIST, new ArrayList<Object>());
    ...
    public List<Periodicity> getManufacturingMaintenancePeriodicityList() {
      return (List<Periodicity>) get(PROPERTY_MANUFACTURINGMAINTENANCEPERIODICITYLIST);
    }

    public void setManufacturingMaintenancePeriodicityList(List<Periodicity> manufacturingMaintenancePeriodicityList) {
        set(PROPERTY_MANUFACTURINGMAINTENANCEPERIODICITYLIST, manufacturingMaintenancePeriodicityList);
    }
