...
public class MeasureGroup extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_MANUFACTURINGMEASURETIMELIST = "manufacturingMeasureTimeList";

    public MeasureGroup() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_MANUFACTURINGMEASURETIMELIST, new ArrayList<Object>());
    }
    ...
    public List<MeasureTime> getManufacturingMeasureTimeList() {
      return (List<MeasureTime>) get(PROPERTY_MANUFACTURINGMEASURETIMELIST);
    }

    public void setManufacturingMeasureTimeList(List<MeasureTime> manufacturingMeasureTimeList) {
        set(PROPERTY_MANUFACTURINGMEASURETIMELIST, manufacturingMeasureTimeList);
    }
