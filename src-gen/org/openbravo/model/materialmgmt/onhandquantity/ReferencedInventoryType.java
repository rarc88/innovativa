...
public class ReferencedInventoryType extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_MATERIALMGMTREFERENCEDINVENTORYLIST = "materialMgmtReferencedInventoryList";

    public ReferencedInventoryType() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_SHARED, true);
        setDefaultValue(PROPERTY_MATERIALMGMTREFERENCEDINVENTORYLIST, new ArrayList<Object>());
    }
    ...
    public List<ReferencedInventory> getMaterialMgmtReferencedInventoryList() {
      return (List<ReferencedInventory>) get(PROPERTY_MATERIALMGMTREFERENCEDINVENTORYLIST);
    }

    public void setMaterialMgmtReferencedInventoryList(List<ReferencedInventory> materialMgmtReferencedInventoryList) {
        set(PROPERTY_MATERIALMGMTREFERENCEDINVENTORYLIST, materialMgmtReferencedInventoryList);
    }
