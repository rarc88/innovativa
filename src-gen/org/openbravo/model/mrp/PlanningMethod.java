...
public class PlanningMethod extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_MRPPLANNINGMETHODLINELIST = "mRPPlanningMethodLineList";
    ...
    public PlanningMethod() {
        ...
        setDefaultValue(PROPERTY_MRPPLANNINGMETHODLINELIST, new ArrayList<Object>());
    ...
    public List<PlanningMethodLine> getMRPPlanningMethodLineList() {
      return (List<PlanningMethodLine>) get(PROPERTY_MRPPLANNINGMETHODLINELIST);
    }

    public void setMRPPlanningMethodLineList(List<PlanningMethodLine> mRPPlanningMethodLineList) {
        set(PROPERTY_MRPPLANNINGMETHODLINELIST, mRPPlanningMethodLineList);
    }
