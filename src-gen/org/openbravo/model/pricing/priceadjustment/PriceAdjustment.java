...
public class PriceAdjustment extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_INVOICELINEEMSEIIMOFFERIDLIST = "invoiceLineEMSeiiMOfferIDList";
    ...
    public PriceAdjustment() {
        ...
        setDefaultValue(PROPERTY_INVOICELINEEMSEIIMOFFERIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<InvoiceLine> getInvoiceLineEMSeiiMOfferIDList() {
      return (List<InvoiceLine>) get(PROPERTY_INVOICELINEEMSEIIMOFFERIDLIST);
    }

    public void setInvoiceLineEMSeiiMOfferIDList(List<InvoiceLine> invoiceLineEMSeiiMOfferIDList) {
        set(PROPERTY_INVOICELINEEMSEIIMOFFERIDLIST, invoiceLineEMSeiiMOfferIDList);
    }
