...
public class Resource extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_RESOURCEASSIGNMENTLIST = "resourceAssignmentList";
    public static final String PROPERTY_RESOURCEUNAVAILABLELIST = "resourceUnAvailableList";

    public Resource() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_AVAILABLE, true);
        setDefaultValue(PROPERTY_PRODUCTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_RESOURCEASSIGNMENTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_RESOURCEUNAVAILABLELIST, new ArrayList<Object>());
    }
    ...
    public List<ResourceAssignment> getResourceAssignmentList() {
      return (List<ResourceAssignment>) get(PROPERTY_RESOURCEASSIGNMENTLIST);
    }

    public void setResourceAssignmentList(List<ResourceAssignment> resourceAssignmentList) {
        set(PROPERTY_RESOURCEASSIGNMENTLIST, resourceAssignmentList);
    }

    @SuppressWarnings("unchecked")
    public List<ResourceUnAvailable> getResourceUnAvailableList() {
      return (List<ResourceUnAvailable>) get(PROPERTY_RESOURCEUNAVAILABLELIST);
    }

    public void setResourceUnAvailableList(List<ResourceUnAvailable> resourceUnAvailableList) {
        set(PROPERTY_RESOURCEUNAVAILABLELIST, resourceUnAvailableList);
    }
