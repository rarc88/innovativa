...
public class TestCostingSourceAdjustments extends TestCostingBase {
  ...
  public void testCostingV911() throws Exception {
    ...
    try {
      ...
      ShipmentInOut goodsShipment = TestCostingUtils.createGoodsShipment(product, price2,
          quantity2, day1);
  ...
  public void testCostingCC() throws Exception {
    ...
    try {
      ...
      // Create goods shipment, run costing background, post it and assert it
      ShipmentInOut goodsShipment = TestCostingUtils.createGoodsShipment(product, price1,
          quantity2, day3);
  ...
  public void testCostingE1() throws Exception {
    ...
    try {
      ...
      InventoryAmountUpdate inventoryAmountUpdate = TestCostingUtils.createInventoryAmountUpdate(
          product, price1, price2, quantity1, day2);
  ...
  public void testCostingE3() throws Exception {
    ...
    try {
      ...
      // Create inventory amount update and run costing background
      InventoryAmountUpdate inventoryAmountUpdate = TestCostingUtils.createInventoryAmountUpdate(
          product, price3, price4, price5, quantity1, day5);
  ...
  public void testCostingGG() throws Exception {
    ...
    try {
      ...
      TestCostingUtils.manualCostAdjustment(TestCostingUtils
          .getProductTransactions(product.getId()).get(1), quantity1.multiply(price1), false, day4);
  ...
  public void testCostingH1() throws Exception {
    ...
    try {
      ...
      // Create goods shipment, run costing background, post it and assert it
      ShipmentInOut goodsShipment = TestCostingUtils.createGoodsShipment(product, price3,
          quantity3, day6);

      // Update transaction total cost amount
      TestCostingUtils.manualCostAdjustment(TestCostingUtils
          .getProductTransactions(product.getId()).get(1), quantity1.multiply(price4), false, day5);
  ...
  public void testCostingMC445() throws Exception {
    ...
    try {
      ...
      TestCostingUtils.changeOrganizationCurrency(TestCostingConstants.SPAIN_ORGANIZATION_ID, DOLLAR_ID);
      ...
      // Change organization currency
      TestCostingUtils.changeOrganizationCurrency(TestCostingConstants.SPAIN_ORGANIZATION_ID, EURO_ID);
