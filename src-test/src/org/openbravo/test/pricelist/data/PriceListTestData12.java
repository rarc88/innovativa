...
public class PriceListTestData12 extends PriceListTestData {
  ...
  public void initialize() {
    ...
    productPriceLines.put(PriceListTestConstants.FINAL_GOOD_A_PRODUCT_NAME, new String[] { "3.69",
        "2.66" });
    productPriceLines.put(PriceListTestConstants.FINAL_GOOD_B_PRODUCT_NAME, new String[] { "3.69",
        "2.66" });
    productPriceLines.put(PriceListTestConstants.FINAL_GOOD_C_PRODUCT_NAME, new String[] { "3.69",
        "2.66" });
