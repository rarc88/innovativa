...
public class PriceListTestData5 extends PriceListTestData {
  ...
  public void initialize() {
    ...
    productPriceLines.put(PriceListTestConstants.DISTRIB_GOOD_C_PRODUCT_NAME, new String[] {
        "12.05", "11.03" });
    productPriceLines.put(PriceListTestConstants.LAPTOP_PRODUCT_NAME, new String[] { "12.05",
        "11.03" });
    productPriceLines.put(PriceListTestConstants.SOCCER_BALL_PRODUCT_NAME, new String[] { "12.05",
        "11.03" });
    productPriceLines.put(PriceListTestConstants.SPAIN_GOOD_A_PRODUCT_NAME, new String[] { "12.05",
        "11.03" });
    productPriceLines.put(PriceListTestConstants.SPAIN_GOOD_B_PRODUCT_NAME, new String[] { "12.05",
        "11.03" });
    productPriceLines.put(PriceListTestConstants.SPAIN_GOOD_C_PRODUCT_NAME, new String[] { "12.05",
        "11.03" });
    productPriceLines.put(PriceListTestConstants.T_SHIRTS_PRODUCT_NAME, new String[] { "12.05",
        "11.03" });
    productPriceLines.put(PriceListTestConstants.TENNIS_BALL_PRODUCT_NAME, new String[] { "12.05",
        "11.03" });
    productPriceLines.put(PriceListTestConstants.USA_GOOD_A_PRODUCT_NAME, new String[] { "12.05",
        "11.03" });
    productPriceLines.put(PriceListTestConstants.USA_GOOD_B_PRODUCT_NAME, new String[] { "12.05",
        "11.03" });
    productPriceLines.put(PriceListTestConstants.USA_GOOD_C_PRODUCT_NAME, new String[] { "12.05",
        "11.03" });
