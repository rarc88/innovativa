...
public class TaxesTestData152 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes2.put(TaxDataConstants.TAX_VAT_21, new String[] { "-24.55", "-5.15", "-24.55",
        "-5.15", "-49.09", "-10.31", "-49.09", "-10.31" });
    ...
    lineTaxes3.put(TaxDataConstants.TAX_VAT_10, new String[] { "-8.73", "-0.87", "-8.73", "-0.87",
        "-17.45", "-1.75", "-17.45", "-1.75" });
    ...
    lineTaxes6.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-7.96", "-1.99", "-7.96",
        "-1.99", "-15.92", "-3.98", "-15.92", "-3.98" });
    lineTaxes6.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-5.31", "-2.65", "-5.31",
        "-2.65", "-10.61", "-5.31", "-10.61", "-5.31" });
    ...
    lineTaxes7.put(TaxDataConstants.TAX_SUPER_25, new String[] { "-5.96", "-1.49", "-5.96",
        "-1.49", "-11.92", "-2.98", "-11.92", "-2.98" });
    lineTaxes7.put(TaxDataConstants.TAX_SUPER_50, new String[] { "-3.97", "-1.99", "-3.97",
        "-1.99", "-7.95", "-3.97", "-7.95", "-3.97" });
    ...
    lineTaxes11.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-664.84", "-352.37",
        "-664.84", "-352.37", "-1329.68", "-704.73", "-1329.68", "-704.73" });
    ...
    lineTaxes12.put(TaxDataConstants.TAX_IEPS_53_16, new String[] { "-879.14", "-140.66",
        "-879.14", "-140.66", "-1758.28", "-281.32", "-1758.28", "-281.32" });
    lineTaxes12.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-574.60", "-304.54",
        "-574.60", "-304.54", "-1149.20", "-609.08", "-1149.20", "-609.08" });
    ...
    lineTaxes13.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-674.69", "-357.59",
        "-674.69", "-357.59", "-1349.38", "-715.17", "-1349.38", "-715.17" });
