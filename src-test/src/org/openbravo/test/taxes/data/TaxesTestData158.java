...
public class TaxesTestData158 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes3.put(TaxDataConstants.TAX_VAT_10, new String[] { "-87.27", "-8.73", "-87.27",
        "-8.73", "-174.55", "-17.45", "-174.55", "-17.45" });
    ...
    taxes.put(TaxDataConstants.TAX_IEPS_53_53, new String[] { "-19141.31", "-10144.89",
        "-19141.31", "-10144.90", "-38282.62", "-20289.79", "-38282.62", "-20289.79" });
    setDoctaxes(taxes);
