...
public class TaxesTestData22 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes.put(TaxDataConstants.TAX_VAT_3_Child, new String[] { "-2.90", "-0.09", "-2.90",
        "-0.09", "-5.80", "-0.17", "-5.80", "-0.17" });
    lineTaxes.put(TaxDataConstants.TAX_CHARGE, new String[] { "-2.90", "-0.01", "-2.90", "-0.01",
        "-5.80", "-0.03", "-5.80", "-0.03" });
    ...
    taxes.put(TaxDataConstants.TAX_VAT_3_Child, new String[] { "-2.90", "-0.09", "-2.90", "-0.09",
        "-5.80", "-0.17", "-5.80", "-0.17" });
    taxes.put(TaxDataConstants.TAX_CHARGE, new String[] { "-2.90", "-0.01", "-2.90", "-0.01",
        "-5.80", "-0.03", "-5.80", "-0.03" });
    setDoctaxes(taxes);
