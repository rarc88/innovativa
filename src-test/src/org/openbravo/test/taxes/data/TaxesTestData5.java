...
public class TaxesTestData5 extends TaxesTestData {
  ...
  public void initialize() {
    ...
    lineTaxes.put(TaxDataConstants.TAX_VAT_3_Child, new String[] { "3", "0.09", "3", "0.09", "6",
        "0.18", "6", "0.18" });
    lineTaxes.put(TaxDataConstants.TAX_CHARGE, new String[] { "3", "0.02", "3", "0.02", "6",
        "0.03", "6", "0.03" });
    ...
    taxes.put(TaxDataConstants.TAX_VAT_3_Child, new String[] { "3", "0.09", "3", "0.09", "6",
        "0.18", "6", "0.18" });
    taxes.put(TaxDataConstants.TAX_CHARGE, new String[] { "3", "0.02", "3", "0.02", "6", "0.03",
        "6", "0.03" });
    setDoctaxes(taxes);
