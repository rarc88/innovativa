...
public abstract class AcctServer {
  ...
  public void run(VariablesSecureApp vars) throws IOException, ServletException {
    run(vars, null, null, null);
  }

  public void run(VariablesSecureApp vars, String strDateFrom, String strDateTo, String strDocType)
    ...
    try {
      ...
      String strDocTypeWhereCondition = StringUtils.isNotBlank(strDocType) ? (" AND  a.C_DocType_Id = '")
          .concat(strDocType + "'") : strDocType;

      data = AcctServerData.select(connectionProvider, tableName, strDateColumn, AD_Client_ID,
          strOrgs, strDocTypeWhereCondition, strDateFrom, strDateTo, limit);
  ...
  public static AcctServer get(String AD_Table_ID, String AD_Client_ID, String AD_Org_ID,
    ...
    if (AD_Table_ID.equals("318") || AD_Table_ID.equals("800060") || AD_Table_ID.equals("800176")
        ...
        || AD_Table_ID.equals("472") || AD_Table_ID.equals("643A10788DE848AAA433B79C8157710A")
        || AD_Table_ID.equals("211492B753264EAEBE328BA4FED1F066")
        //|| AD_Table_ID.equals("5E2670C090A14B798B165203C31FA920")
		|| AD_Table_ID.equals("BCEEDEC4FE2B4B3FAEA32084BB88AD95")) {
      if (AD_Table_ID.equals("643A10788DE848AAA433B79C8157710A")) {
        AD_Table_ID = "777";
      }
      if (AD_Table_ID.equals("211492B753264EAEBE328BA4FED1F066")) {
        AD_Table_ID = "7777";
      }
      if (AD_Table_ID.equals("5E2670C090A14B798B165203C31FA920")) {
        AD_Table_ID = "5555";
      }
	  if (AD_Table_ID.equals("BCEEDEC4FE2B4B3FAEA32084BB88AD95")) {
        AD_Table_ID = "1111";
      }
      ...
      case 777:
        acct = new DocBudgetCertificate(AD_Client_ID, AD_Org_ID, connectionProvider);
        acct.tableName = "sfb_budget_certificate";
        acct.strDateColumn = "Date_Issue";
        acct.AD_Table_ID = "643A10788DE848AAA433B79C8157710A";
        acct.reloadAcctSchemaArray();
        break;

      case 7777:
        acct = new DocWithholdingSale(AD_Client_ID, AD_Org_ID, connectionProvider);
        acct.tableName = "ssws_withholdingsale";
        acct.strDateColumn = "DateAcct";
        acct.AD_Table_ID = "211492B753264EAEBE328BA4FED1F066";
        acct.reloadAcctSchemaArray();
        break;

        //case 5555:
        //acct = new DocViaticalSettlement(AD_Client_ID, AD_Org_ID, connectionProvider);
        //acct.tableName = "ssve_viatical_settlement";
        //acct.strDateColumn = "ViaticalDate";
        //acct.AD_Table_ID = "5E2670C090A14B798B165203C31FA920";
        //acct.reloadAcctSchemaArray();
        //break;

      case 1111:
        acct = new DocPayroll(AD_Client_ID, AD_Org_ID, connectionProvider);
        acct.tableName = "SSPR_Payroll";
        acct.strDateColumn = "DateDoc";
        acct.AD_Table_ID = "BCEEDEC4FE2B4B3FAEA32084BB88AD95";
        acct.reloadAcctSchemaArray();
        break;
  ...
  public boolean checkDocuments() throws ServletException {
    return checkDocuments(null, null, null);
  }

  public boolean checkDocuments(String dateFrom, String dateTo, String strDocTypeId)
      throws ServletException {
    if (m_as.length == 0)
      return false;

    String strDocTypeWhereCondition = StringUtils.isNotBlank(strDocTypeId) ? (" AND  C_DocType_Id = '")
        .concat(strDocTypeId + "'") : strDocTypeId;

    AcctServerData[] docTypes = AcctServerData.selectDocTypes(connectionProvider, AD_Table_ID,
        AD_Client_ID, strDocTypeWhereCondition);
    // if (log4j.isDebugEnabled())
    ...
    for (int i = 0; i < docTypes.length; i++) {
      ...
      AcctServerData data = AcctServerData.selectDocumentsDates(connectionProvider, strDateColumn,
          tableName, AD_Client_ID, strorgs, strDocTypeWhereCondition.concat(" AND "),
          docTypes[i].name, dateFrom, dateTo);
  ...
  public boolean filterDatesCheckDocuments(String dateFrom, String dateTo) throws ServletException {
    return checkDocuments(dateFrom, dateTo, null);
