...
public class CallAcctServer extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strDocType = vars.getStringParameter("inpdocTypeId");
      ...
      printPage(response, vars, strTableId, strAdOrgId, "", strDateFrom, strDateTo, strDocType);
  ...
  private void printPage(HttpServletResponse response, VariablesSecureApp vars, String strTableId,
      String strOrgId, String strMessage, String strDateFrom, String strDateTo, String strDocType)
    ...
    }
    {
      ...
      data = AcctServerData.selectDocumetType(this, strTableId);
      xmlDocument.setData("reportdocTypeId", "liststructure", data);

      xmlDocument.setParameter("docTypeId", strDocType);
  ...
  private void runProcess(HttpServletResponse response, VariablesSecureApp vars, String strTableId,
      String strOrgId, String adProcessId, String strDateFrom, String strDateTo, String strDocType)
      throws IOException, ServletException {
    ...
    try {
      ...
      if (!scheduled) {
        ...
        PInstanceProcessData.insertPInstanceParam(this, adPinstanceId, "40", "DateTo", strDateTo,
            vars.getClient(), vars.getOrg(), vars.getUser());
        PInstanceProcessData.insertPInstanceParam(this, adPinstanceId, "50", "C_DocType_ID",
            strDocType, vars.getClient(), vars.getOrg(), vars.getUser());
      ...
      printPage(response, vars, strTableId, strOrgId, "", strDateFrom, strDateTo, strDocType);
    }
  }
