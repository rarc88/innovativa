...
public class DocWithholdingSale extends AcctServer {
  private static final long serialVersionUID = 1L;
  private String SeqNo = "0";

  static Logger log4jDocWithholdingSale = Logger.getLogger(DocWithholdingSale.class);
   ...
   *          AD_Client_ID
   */
  public DocWithholdingSale(String AD_Client_ID, String AD_Org_ID,
      ConnectionProvider connectionProvider) {
    super(AD_Client_ID, AD_Org_ID, connectionProvider);
  }

  public String nextSeqNo(String oldSeqNo) {
    log4jDocWithholdingSale.debug("DocWithholdingSale - oldSeqNo = " + oldSeqNo);
    BigDecimal seqNo = new BigDecimal(oldSeqNo);
    SeqNo = (seqNo.add(new BigDecimal("10"))).toString();
    log4jDocWithholdingSale.debug("DocWithholdingSale - nextSeqNo = " + SeqNo);
    return SeqNo;
  }
  ...
  public boolean loadDocumentDetails(FieldProvider[] data, ConnectionProvider conn) {
    ...
    log4jDocWithholdingSale.debug("data.length = " + data.length + " - DocumentType = "
        + DocumentType);
    ...
    log4jDocWithholdingSale.debug("Lines=" + p_lines.length);
    return true;
  } // loadDocumentDetails
  ...
  public Fact createFact(AcctSchema as, ConnectionProvider conn, Connection con,
    ...
    log4jDocWithholdingSale.debug("Starting create fact");
