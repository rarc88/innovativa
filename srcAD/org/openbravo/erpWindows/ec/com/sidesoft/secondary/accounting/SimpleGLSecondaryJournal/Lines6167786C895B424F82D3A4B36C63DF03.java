...
public class Lines6167786C895B424F82D3A4B36C63DF03 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "B487A6D6A9334751AE62DF02CBFBD2CD";
  private static final String tabId = "6167786C895B424F82D3A4B36C63DF03";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
    ...
    } else if (vars.commandIn("BUTTONAddpaymentDE1B382FDD2540199D223586F6E216D0")) {
        vars.setSessionValue("buttonDE1B382FDD2540199D223586F6E216D0.straddpayment", vars.getStringParameter("inpaddpayment"));
        ...
        String strSsacct_Journalline_ID = vars.getGlobalVariable("inpssacctJournallineId", windowId + "|Ssacct_Journalline_ID", "");
        String straddpayment = vars.getSessionValue("buttonDE1B382FDD2540199D223586F6E216D0.straddpayment");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonAddpaymentDE1B382FDD2540199D223586F6E216D0(response, vars, strSsacct_Journalline_ID, straddpayment, strProcessing);
        }


    } else if (vars.commandIn("SAVE_BUTTONAddpaymentDE1B382FDD2540199D223586F6E216D0")) {
        String strSsacct_Journalline_ID = vars.getGlobalVariable("inpKey", windowId + "|Ssacct_Journalline_ID", "");
        
        ProcessBundle pb = new ProcessBundle("DE1B382FDD2540199D223586F6E216D0", vars).init(this);
        HashMap<String, Object> params= new HashMap<String, Object>();
       
        params.put("Ssacct_Journalline_ID", strSsacct_Journalline_ID);
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonAddpaymentDE1B382FDD2540199D223586F6E216D0(HttpServletResponse response, VariablesSecureApp vars, String strSsacct_Journalline_ID, String straddpayment, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process DE1B382FDD2540199D223586F6E216D0");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/AddpaymentDE1B382FDD2540199D223586F6E216D0", discard).createXmlDocument();
      xmlDocument.setParameter("key", strSsacct_Journalline_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Lines6167786C895B424F82D3A4B36C63DF03_Edition.html");
